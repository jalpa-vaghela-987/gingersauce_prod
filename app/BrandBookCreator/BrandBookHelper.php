...
class BrandBookHelper {
    ...
    public static function getArchetypePng_src( $archetype ) {
        $file_name = str_replace( ' ', '', strtolower( $archetype ) );
        if ( $file_name ) {
            $file_name .= '.png';
            return url( 'img' ) . DIRECTORY_SEPARATOR . 'archetype' . DIRECTORY_SEPARATOR . $file_name ;
        }
        return false;
    }
    ...
    //check branbook is old or new. if return true then it's old and if return false then it's new
    // public static function isOldBrandBook($brandBook) {
    //    if($brandBook->tabCount() > 0) {
    //        return false;
    //    }
    //    return true;
    // }
