...
class User extends \TCG\Voyager\Models\User {
    ...
    public function completedBrandbooks() {

        return $this->hasMany( 'App\Brandbook' )->where( 'expires_at', '>', Carbon::now() )->where('completed','>=',24);
    }
    ...
    public function paymentDefault() {
        return $this->storedCards()->where( 'default', 1 )->latest();
    }
