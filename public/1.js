      ...
      function E(_ref) {
        ...
        return {
          update: function update(s) {
            ...
            for (var _i3 = 0, _arr = [l, !l]; _i3 < _arr.length; _i3++) {
              var _t2 = _arr[_i3];
      ...
      var D = /*#__PURE__*/function () {
        ...
        return _createClass(D, [{
          ...
          value: function _preBuild() {
            var t = this.options;
            for (var _i4 = 0, _arr2 = ["el", "container"]; _i4 < _arr2.length; _i4++) {
              var _e6 = _arr2[_i4];
              t[_e6] = f(t[_e6]);
            }
    ...
    function u(t) {
      ...
      for (var _t15 = 0; _t15 < n.length; _t15++) {
        ...
        if (!_u.length && _a2) i.push({
          ...
          var _iterator6 = _createForOfIteratorHelper(_u),
            _step6;
          try {
      ...
      for (var _t17 = 0; _t17 < i.length; _t17++) {
        ...
        if (!_e17.loc) if (_t17) {
          var _o18 = 2,
            _n10 = _t17 + 1;
          for (; _n10 < i.length && !i[_n10].loc; _n10++) _o18++;
    ...
    var b = /*#__PURE__*/function () {
      function b(t) {
        ...
        f(this, "_stops", []), f(this, "_angle", 0), f(this, "_angles", [{
          ...
          var _iterator7 = _createForOfIteratorHelper(t.stops),
            _step7;
          try {
