<template>
    <div class="plan-item row">
        <div class="plan-item-icon col-2">
            <svg class="svg-calendar" v-if="book" width="32" height="37" viewBox="0 0 32 37" fill="none"
        ...
        <div class="plan-info-item-wrapper col-7">
            ...
            <div class="plan-item-info">
                <div class="plan-item-label">{{
                        plan ? translate('Plan expires') : translate('Book Expiry Date')
                    }}
                </div>
                <div class="plan-item-field">{{ expire_date }}</div>
