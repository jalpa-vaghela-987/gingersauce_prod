...
@section('content')
    <div class="content" style="text-align: center; padding: 50px 0 0 50px;">
        ...
        <div class="bold-text">Dear user!</div>
        <div class="text">We are sorry that we have found out that during generation of your Brand Book, a technical issue interrupted the process.</div>
        <div class="text">We have successfully fixed it and we are happy to let You know that you can freely use the service with no interruption.</div>
        <div class="text">We thank you for your the cooperation and understanding!</div>
