...
export default {
    ...
    methods: {
        async handleIconDownload(format) {
            await this.downloadFile(this.img, format);
        },
        async handleIconCopy(format) {
            await this.copyFile(this.img, format);
        },
