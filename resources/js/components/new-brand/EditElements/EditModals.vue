    ...
    saveChanges() {
      if (this.currentElement) {
        ...
        if (this.currentElement.nodeName.startsWith('H')) {
          ...
          this.defaultBrandbook.tabs[tabIndex].tab_contents[tabContentIndex].title = this.headerText;
          $('#headingModalEdit').modal('hide');
        } else if (this.currentElement.nodeName == 'DIV') {
          this.currentElement.innerHTML = this.simpleText;
          this.defaultBrandbook.tabs[tabIndex].tab_contents[tabContentIndex].description = this.simpleText;
          ...
          this.defaultBrandbook.tabs[tabIndex].tab_contents[tabContentIndex].image = this.imageData;;
          this.defaultBrandbook.tabs[tabIndex].tab_contents[tabContentIndex].width = this.width;
