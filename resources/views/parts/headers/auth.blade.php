@if (
    !(
        (
            (\Request::segment(2) === 'edit-new' || \Request::segment(2) === 'view-new')
            && is_numeric(\Request::segment(3))
        )
        || (\Request::segment(2) === 'view-new-v3' && is_numeric(\Request::segment(3)))
    )
)
    {{-- DEBUG: REMOVE LATER --}}
    <header class="auth">
        <nav class="navbar navbar-expand-md navbar-light bg-white">
            <div class="h-100 p-0">
                <div class="brand-logo-block text-center h-100">
                    ...
                    <?php /*<a href="/my/new" class="header-add-new d-none btn btn-danger rounded-0 h-100"
                ...
                <ul class="navbar-nav navbar-user">
                    ...
                    <li class="nav-item package-block">
                        ...
                        <li class="nav-item mt-2">
                            @if (Auth::user()->package && floatval(Auth::user()->package->price) > 0.0)
                                <button
                                    class="font-weight-bold btn plan-btn paid-plan-btn"> Paid Plan
                                </button>

                            @else
                                <button
                                    class="font-weight-bold btn plan-btn free-plan-btn"> Free Plan
                                </button>
                            @endif
                        </li>
                        <li class="nav-item dropdown pl-0 nav-item-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right main-menu-block"
