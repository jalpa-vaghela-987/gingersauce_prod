...
<head>
	...
	background-repeat: no-repeat;*/
        ...
        .gradient-theme #page1 .logo svg, .gradient-theme #page1 .logo img {
        ...
        #page3, #page5, #page7, #page8, #page9, #page10, #page11, #page12, #page14, #page16, #page16-1, #page18, #page19, #page20, #page24, #page25, #page26, #page26-1 {
        ...
        #page11, #page14, #page15, #page16, #page16-1, #page17, #page17-1, #page23, #page25, #page26, #page27, #page28, #page29, #page30, #page31, #page27-1, #page26-26 {
            padding: 90px;
        }
        ...
        #page5 h1.title:after, #page12 h1.title:after, #page26-1 h1.title:after {
            @if(isset($data->colors_list[1]))
        ...
        #page5 .text, #page10 .text, #page12 .text, #page26-1 .text {
            font-size: 16px;
        }
        ...
        #page11 .core-values .core-value:nth-child(2n+1) { order: 1; }
        #page11 .core-values .core-value:nth-child(2n+2) { order: 2; }
        #page11 .core-values .core-value:nth-child(2n)   { order: 3; }
        ...
        #page11 .core-values .core-value .title {
            font-weight: 800;
            font-size: {{26-$title_length/180}}px;
            line-height: 120%;
            margin-bottom: 10px;
        }
        ...
        #page11 .core-values .core-value div {
            font-weight: normal;
            font-size: {{17-$text_length/300}}px;
            line-height: 120%;
            position: relative;
        }
        ...
        #page11 .core-values .core-value{
        @php
        if($text_length>1500) echo 'margin-bottom: 0px';
        @endphp
}
        ...
        #page19 .logo, #page19 .icon, #page21 .logo, #page20 .icon {
...
#page19 .icon:after{
	...
	border-right: 1px solid #dadada;
        ...
        #page19 .icon .logo-image, #page19 .logo .logo-image, #page20 .icon .logo-image, #page21 .logo .logo-image, #page23 .logo .logo-image, #page23 .icon .logo-image, #page25 .logo .logo-image {
            background-size: contain;
            background-position: center;
            background-repeat: no-repeat;
            width: 100%;
...
#page21 .logo-post .right:after{
    ...
    text-align: center;
        ...
        #page20 .icon-post .left, #page20 .icon-pre .left {
            height: 30px;
            width: 30px;
            border: 1px solid #dadada;
            content: "x";
        ...
        #page20 .icon-post .right, #page20 .icon-pre .right {
            height: 30px;
            width: 30px;
            border: 1px solid #dadada;
            color: #dadada;
        ...
        #page27 .color-block, #page26-26 .color-block {
            position: relative;
            width: 50%;
            float: left;
            text-align: center;
        ...
        #page27 .color-block .title, #page26-26 .color-block .title {
            margin-bottom: 10px;
        }

        #page27 .color-block .color-title, #page26-26 .color-block .color-title {
            position: absolute;
            font-size: 10px;
            text-align: left;
            left: 10px;
        ...
        #page27 .color-block .color-title.ct1, #page26-26 .color-block .color-title.ct1 {
            top: 38px;
        }

        #page27 .color-block .color-title.ct2, #page26-26 .color-block .color-title.ct2 {
            top: 78px;
        }

        #page27 .color-block .color-title.ct3, #page26-26 .color-block .color-title.ct3 {
            top: 119px;
        }

        #page27 .color-block .color-title.ct4, #page26-26 .color-block .color-title.ct4 {
            top: 161px;
        }

        #page27 .color-description-block, #page26-26 .color-description-block {
            margin-top: 20px;
            margin-bottom: 50px;
            padding-left: 100px;
        }

        #page27 .color-description-block .key-value, #page26-26 .color-description-block .key-value {
            clear: both;
        }

        #page27 .color-description-block .key-value .key, #page26-26 .color-description-block .key-value .key {
            float: left;
            font-style: normal;
            font-weight: normal;
            font-size: 10px;
        ...
        #page27 .color-description-block .key-value .value, #page26-26 .color-description-block .key-value .value {
            font-style: normal;
            font-weight: normal;
            font-size: 12px;
            line-height: 20px;
        ...
        #page27.colors-4 .color-block, #page26-26.colors-4 .color-block {
            margin-top: 120px;
            transform: none;
        }
...
<div class="gradient-theme">
    ...
    >
        @if(empty($data->custom_logo))
            ...
            <div class="logo toWhiteSVGs">
                @if(!empty($data->all_logo_variations['0_White Negative on Primary']['logo']))
                    <img src="{{$data->all_logo_variations['0_White Negative on Primary']['logo_b64']}}">
                @else
                    {!! $data->logo !!}
                @endif
            </div>
    ...
    <div id="page5">
        ...
        <h1 class="title" contenteditable="true" data-title-field="introduction_title">
            {!!
                !empty($data->introduction_title) ?
                    $data->introduction_title :
                    trans('themes.introduction')
            !!}
        </h1>
    ...
    @if(!empty($data->vision_text) || !empty($data->vision))
        ...
        <div id="page7">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="vision_title">
                {!!
                    !empty($data->vision_title) ?
                        $data->vision_title :
                        trans('themes.vision')
                !!}
            </h1>
            <div class="text text-white autosize vision-text" data-field="vision_text">
                <div>
            ...
            @if($data->watermark)
                <img class="watermark-draft" src="/img/watermark-draft.png">
            @endif
        </div>
    ...
    @if(!empty($data->mission_text) || !empty($data->mission))
        <div id="page8">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="mission_title">
                {!!
                    !empty($data->mission_title) ?
                        $data->mission_title :
                        trans('themes.mission')
                !!}
            </h1>
            <div class="text autosize mission-text" data-field="mission_text"><div>
    ...
    @if(count($data->core_values)>0)
        <div id="page10">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="core_title">
                {!!
                    !empty($data->core_title) ?
                        $data->core_title :
                        trans('themes.core_values')
                !!}
            </h1>
            ...
            @if($data->watermark)
                <img class="watermark-draft" src="https://pp.gingersauce.com/img/watermark-draft.png">
            @endif
        </div>
    ...
    @if(!empty($data->voices))
        <div id="page-voices-1" class="{{count($data->voices) === 1 ? 'single' : ''}}">
            @php
                $page_number++;
            @endphp
            <div class="page-number">{{$page_number}}</div>
            <div class="voices-wrapper">
                ...
                <div class="voices-images">
                    ...
                    <div class="archetype-names">
                        <div class="archetype-name">{{$data->voices[0]}}</div>
                        @if(!empty($data->voices[1]))
                            <div class="archetype-and">
                                &
                            </div>
                            <div class="archetype-name">{{$data->voices[1]}}</div>
                        @endif
                    </div>
                    @if(!empty($data->voices[1]))
                        <div class="archetype-image-wrap">
        ...
        <div id="page-voices-2" class="{{count($data->voices) === 1 ? 'single' : ''}}">
            ...
            <div class="voices-wrapper">
                <div class="voices-description">
                    <div class="archetype-descritpion">
    ...
    <div id="page12">
        @php
            $page_number++;
        @endphp
        <div class="page-number text-white" id="Our Logo">{{$page_number}}</div>
        <div class="gradient-block"></div>
        <h1 class="title text-white" contenteditable="true" @blur="title_changed()"
    ...
    @if(count($data->approved)>0)
        <div id="page14" class="logo-size-1">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="versions_title">
                {!!
                    !empty($data->versions_title) ?
                        $data->versions_title :
                        trans('themes.logo_versions')
                !!}
            </h1>
                ...
                <div class="logo-versions" style="position: relative; z-index: 2;">
                    @foreach($chunk as $logo)
                        <div class="logo-version version" style="background: {{$logo['background']}}">
                            ...
                            @endphp
                            <div class="logo-title" style="color : {{\App\BrandBookCreator\BrandBookHelper::getLogoTextColor($background)}}">
                                {{$logo['title']}}
                            </div>
                        </div>
                    @endforeach
    ...
    <div id="page18">
        ...
        @php
            ...
            // $xval = (floatval($proportions_x) > 0) ? 'f'.floatval($proportions_x) : $proportions_x==='x'? 'g'.str_replace('x', '', $proportions_y):1;
        ...
        <div class="background">
            <svg width="250" height="471" viewBox="0 0 250 471" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                        d="M55.4574 351L32.1052 316.052L9.07512 351H-27.3221L13.7456 293.988L-25.5506 238.265H10.3635L32.9105 270.797L55.1353 238.265H89.5999L50.3038 292.7L92.1767 351H55.4574Z"
                        fill="#DADADA"/>
            </svg>
        </div>
        @if($data->watermark)
    ...
    <div id="page20">
        ...
        <h1 class="title" contenteditable="true" data-title-field="space_title">
            {!!
        ...
        @if(!empty($data->icon) && $data->icon!='skipped' && $data->icon!='[]')
            ...
            <div class="icon iconster space-{{$data->space}}"
                 style="width: {{$data->icon_w}}px; height: {{$data->icon_h}}px;margin-left: -{{$data->icon_w/2}}px;">
    ...
    <div id="page21">
        ...
        <div class="view-block space-{{$data->space}}"
             style="position: relative;top:{{($data->logo_h>0?$data->logo_h/2+$free_space_y_h:1)+($data->space=='hawkins'?0:200)}}px;@if($data->logo_w/$data->logo_h<1 && $data->logo_h>=100)transform:scale(.8)@endif @if(empty($data->icon) || $data->icon=='skipped' || $data->icon=='[]') top: 50%; margin-top: -{{$data->logo_h/2}}px; @endif">
        ...
        <div class="background">
            <svg width="749" height="303" viewBox="0 0 749 303" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g clip-path="url(#clip0)">
                    ...
                    <path d="M96.3721 135L96.3721 240.674" stroke="white" stroke-width="3"
                          stroke-dasharray="26.42 13.21"/>
                    <path d="M436.628 240.674L463.797 287.732H409.459L436.628 240.674Z" fill="white"/>
                    <path d="M436.628 135L436.628 240.674" stroke="white" stroke-width="3"
                          stroke-dasharray="26.42 13.21"/>
                </g>
    ...
    <div id="page23">
        ...
        <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="size_title">
            {!!
                !empty($data->size_title) ?
                    $data->size_title :
                    trans('themes.minimum_size')
            !!}
        </h1>
        <div class="text" data-field="size_text">
            @if(!empty($data->size_text))
                {!!$data->size_text!!}
            @else
                {{trans('themes.establishing')}}
            @endif
        </div>
        <div class="logo"
             style="height: auto; width: @if($data->size=='quark')71px;@endif @if($data->size=='neutron')100px;@endif @if($data->size=='atom')160px;@endif @if($data->size=='molecule')214px;@endif">
            @if(isset($white_bg_logo))
        ...
        <div class="logo_after" style="
            ...
            @if($data->size=='quark' || $data->size=='neutron')line-height: 1em;padding-top: 10px;@endif
                ...
                60mm @endif</div>
            <svg width="19" height="51" class="last" viewBox="0 0 19 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.5 32L17.7272 46.25H1.27276L9.5 32Z" fill="#999999"/>
                <path d="M9.5 2.18554e-08L9.5 32" stroke="#999999" stroke-width="1" stroke-dasharray="8 4"/>
            </svg>
        </div>
        ...
        @if(!empty($data->icon) && $data->icon!='skipped' && $data->icon!='[]')
            <div class="icon"
                 style="height: auto;width: @if($data->size=='quark')10px;@endif @if($data->size=='neutron')14px;@endif @if($data->size=='atom')22px;@endif @if($data->size=='molecule')30px;@endif">
    ...
    @if(!empty($data->missuses))
        <div id="page24">
            ...
            <h1 class="title text-white" contenteditable="true" @blur="title_changed()" data-title-field="misuse_title">
                {!!
                    !empty($data->misuse_title) ?
                        $data->misuse_title :
                        trans('themes.logo_misuse')
                !!}
            </h1>
            <div class="text text-white" data-field="misuse_text">
                @if(!empty($data->misuse_text))
                    {!!$data->misuse_text!!}
                @else
                    {!! trans('themes.it_is_important_that_appearance') !!}
                @endif
            </div>
    ...
    <div id="page26">
        ...
        <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="pallette_title">
            {!!
                !empty($data->pallette_title) ?
                    $data->pallette_title :
                    trans('themes.our_color_palette')
            !!}</h1>
    ...
    <div id="page27-27" style="position: relative;">
        ...
        @if(isset($data->colors_list[0]))
            <div class="primary-color"
                ...
                <div class="color-code"
                     style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}};">{{$data->colors_list[0]->id}}</div>
            </div> @endif
        @if(isset($data->colors_list[1]))
            <div class="secondary-color"
                 style="width: 380px;height: 500px;position: absolute; right: 0; bottom: 0;background: {{$data->colors_list[1]->id}}">
                <div class="color-code"
                     style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[1]->id)}};">{{$data->colors_list[1]->id}}</div>
            </div> @endif
        @if(isset($data->colors_list[2]))
            <div class="tratiary-color"
                 style="width: 380px;height: 260px;position: absolute; right: 0; top: 0;background: {{$data->colors_list[2]->id}}">
                <div class="color-code"
                     style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[2]->id)}};">{{$data->colors_list[2]->id}}</div>
            </div> @endif
        @if($data->watermark)
            <img class="watermark-draft" src="{{$watermark}}">
        @endif
    ...
    <div id="page26-26" class="@if(count($data->colors_list)<5) colors-4 @endif">
        ...
        @foreach($data->colors_list as $c=>$color)
            @if($c<$cllimit && $c>=$cloffset)
                ...
                @if(isset($color->color))
                    <div class="color-block" style="@if($c<2) margin-top:22px; @else margin-top: 0px; @endif">
                        ...
                        @if($color->show_shades)
                            <div
                                    class="color-title ct1">{{\App\BrandBookCreator\BrandBookHelper::adjustBrightness($color->color->hex->value, 153)}}</div>
                            <div
                                    class="color-title ct2">{{\App\BrandBookCreator\BrandBookHelper::adjustBrightness($color->color->hex->value, 76)}}</div>
                            <div class="color-title ct3">{{$color->color->hex->value}}</div>
                            <div
                                    class="color-title ct4">{{\App\BrandBookCreator\BrandBookHelper::adjustBrightness($color->color->hex->value, -76)}}</div>
                        @endif
            ...
            @endif
        @endforeach
        @if(count($data->colors_list)<5)
            <div class="text-small" style="font-size: 12px;">
                {!! trans('themes.instead_of_the_colors') !!}
            </div>
        @endif
        @if($data->watermark)
            ...
            @if($c<$cllimit && $c>=$cloffset)
                ...
                @if(isset($color->color))
                    <div class="color-block"
                         style="@if(count($data->colors_list)>4) @if($c-$cloffset<2) margin-top: 40px; @else margin-top: 0px; @endif @endif">
                        <div class="title" style="padding-left: 110px;">{{$color->color->name->value}}</div>
                        <svg width="231" height="155" viewBox="0 0 231 155" fill="none"
                             xmlns="http://www.w3.org/2000/svg"
                             style="">
    ...
    <div id="page28">
        ...
        @if(isset($data->fonts_main[1]))
            <div class="huge-text text-one">
                <div style="overflow: hidden; height: 85px; width: 100%;">{{$data->fonts_main[1]['font_face']}}</div>
                <small>
                    {{$data->fonts_main[1]['font_face']}} {{$data->fonts_main[1]['weight']}} 100 Pt
                </small>
            </div>
            <div class="huge-text text-two">
                <div style="overflow: hidden; height: 80px; width: 100%;">{{$data->fonts_main[1]['font_face']}}</div>
                <small>
                    {{$data->fonts_main[1]['font_face']}} {{$data->fonts_main[1]['weight']}} 70 Pt
                </small>
            </div>
            <div class="huge-text text-three">
                <div style="overflow: hidden; height: 86px; width: 100%;">{{$data->fonts_main[1]['font_face']}}</div>
                <small>
                    {{$data->fonts_main[1]['font_face']}} {{$data->fonts_main[1]['weight']}} 50 Pt
                </small>
            </div>
            @if(isset($data->colors_list[3]))
                <div class="huge-text text-four">
                    <div
                            style="overflow: hidden; height: 52px; width: 100%;">{{$data->fonts_main[1]['font_face']}}</div>
                    <small>
                        {{$data->fonts_main[1]['font_face']}} {{$data->fonts_main[1]['weight']}} 30 Pt
                    </small>
                </div>
            @endif
        @endif
    ...
    <div id="page30">
        ...
        @endphp
        <div class="page-number">{{$page_number}}</div>
        <div class="fonts2-title">{{trans('themes.primary_font')}}</div>
    ...
    <div id="page31">
        ...
        <div class="page-number right">{{$page_number}}</div>
        @if(isset($data->fonts_secondary) && isset($data->fonts_secondary[1]))
            <div class="fonts2-title">{{trans('themes.secondary_font')}}</div>
            <div class="gradient-line"></div>
        @endif
        @if(isset($data->fonts_secondary) && isset($data->fonts_secondary[1]))
    ...
    <div id="page32">
        @php
            $page_number++;
        @endphp
        <div class="page-number text-white" id="Brandbook designer">{{$page_number}}</div>
        <div class="gradient"></div>
        <div class="user-info">
            <div class="image">
        ...
        <h1 class="title text-white">{{trans('themes.brand_book_designer')}}</h1>
        ...
        <div class="company">
            <div class="company-logo">
                <img src="{{$data->user->company_logo}}" alt="" style="max-width: 150px;">
            </div>
            <div class="web">
                <p>{{$data->user->company_web}}</p>
                @if(!empty($data->user->company_dribble))
                    <p><i class="fa fa-dribbble"
                          style="margin-right: 5px; display: inline-block;"></i>{{$data->user->company_dribble}}</p>
                @endif
                @if(!empty($data->user->company_behance))
                    <p><i class="fa fa-behance"
                          style="margin-right: 5px; display: inline-block;"></i>{{$data->user->company_behance}}</p>
                @endif
            </div>
            <div class="contact">
                <p>{{trans('themes.contact')}}</p>
                @if(!empty($data->user->company_phone))
                    <p><i class="fa fa-mobile"
                          style="margin-right: 5px; display: inline-block;"></i>{{$data->user->company_phone}}</p>
                @endif
                @if(!empty($data->user->email))
                    <p><i class="fa fa-envelope"
                          style="margin-right: 5px; display: inline-block;"></i>{{$data->user->email}}</p>
                @endif
            </div>
        </div>
        @if($data->watermark)
