    ...
    <style>
        ...
        * {
        ...
        #page11 .core-values .core-value .title {
            font-weight: 300;
            font-size: {{25-$title_length/180}}px;
            line-height: 110%;
            margin-bottom: 20px;
        }

        #page11 .core-values .core-value .text {
            font-size: {{18-$text_length/300}}px;
        }
...
<div class="grey-theme">
    ...
    @if(!empty($data->vision_text) || !empty($data->vision))
        ...
        <div id="page7" style="background: #d4d4d4">
            ...
            <div class="text text-white autosize" data-field="vision_text" style="border-bottom: 1px solid #fff;">
                <div>
    ...
    @if(!empty($data->mission_text) || !empty($data->mission))
        <div id="page8">
            ...
            <div class="text autosize" data-field="mission_text"
                 style="position: relative;z-index: 2;border-bottom: 1px solid #000;"><div>
    ...
    @if(!empty($data->voices))
        <div id="page-voices-1" class="{{count($data->voices) === 1 ? 'single' : 'double'}}">
            ...
            <div class="voices-wrapper">
                <h1 class="title"
                    style="color : {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}}">
                ...
                <div class="voices-images">
                    ...
                    @if(!empty($data->voices[1]))
                        ...
                        <div class="voices-names">
                            {{$data->voices[0]}} & {{$data->voices[1]}}
                        </div>
                    @endif
                </div>
                <svg class="voices-circle" width="77" height="77" viewBox="0 0 77 77" fill="none"
            ...
            <div class="voices-wrapper">
                <div class="voices-description">
                    <div class="archetype-descritpion">
                        <p style="color : {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}}">{!! \App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[0]]['description']!!}</p>
                        <div
                                class="voices-descritpion-short"
                                style="color : {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}}">{{\App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[0]]['short_description']}}</div>
                    </div>
                    @if(!empty($data->voices[1]))
                        <div class="archetype-descritpion">
                            <p style="color : {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}}">{{\App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[1]]['description']}}</p>
                            <div
                                    class="voices-descritpion-short"
                                    style="color : {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}}">{{\App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[1]]['short_description']}}</div>
                        </div>
                    @endif
                    <div class="voices-text"
                         style="color : {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}}">{{trans('themes.archetype_text')}}</div>
                </div>
            </div>
            @if($data->watermark)
                <img class="watermark-draft" src="{{$watermark}}">
...
<div id="page27-27" style="position: relative;">
    ...
    @if(isset($data->colors_list[0]))
        <div class="primary-color"
            ...
            <div class="color-code"
                 style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm;transform: rotate(90deg);transform-origin: left top;top: 10mm;left: 15mm; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}};">{{$data->colors_list[0]->id}}</div>
        </div> @endif
    @if(isset($data->colors_list[1]))
        <div class="secondary-color"
             style="width: 280px;height: 760px;position: absolute; right: 100px; bottom: 0;background: {{$data->colors_list[1]->id}}">
            <div class="color-code"
                 style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm;transform: rotate(90deg);transform-origin: left top;top: 10mm;left: 15mm; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[1]->id)}};">{{$data->colors_list[1]->id}}</div>
        </div> @endif
    @if(isset($data->colors_list[2]))
        <div class="tratiary-color"
             style="width: 100px;height: 760px;position: absolute; right: 0; top: 0;background: {{$data->colors_list[2]->id}}">
            <div class="color-code"
                 style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm;transform: rotate(90deg);transform-origin: left top;top: 10mm;left: 15mm; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[2]->id)}};">{{$data->colors_list[2]->id}}</div>
        </div> @endif
    @if($data->watermark)
        <img class="watermark-draft" src="{{$watermark}}">
    @endif
