...
<head>
    ...
    <style>
        ...
        #page-voices-1.single .voices-images {
            width: 100%;
            left: 58px;
            text-align: left;
            height: 60%;
        ...
        * {
        ...
        #page10 .core-values .core-value .text, #page11 .core-values .core-value .text {
            font-size: {{19-$text_length/300}}px;
            margin-right: 40px;
        }
        ...
        #page11 .core-value-wrapper, #page10 .core-value-wrapper{
            width: 100%;
        }
...
<div class="template4 {{$color_class}}">
    ...
    @if(!empty($data->vision_text) || !empty($data->vision))
        ...
        <div id="page7" class="secondary-color-background">
            ...
            @endif
            <div class="text autosize vision-text" data-field="vision_text" data-length="{{strlen($data->vision)}}"
    ...
    @if(!empty($data->mission_text) || !empty($data->mission))
        <div id="page8" class="main-color-background">
            ...
            <div class="page-padding-wrapper" style="padding-top: 300px;">
                ...
                <div class="text main-color autosize mission-text" data-field="mission_text"
    ...
    @if(!empty($data->voices))
        <div id="page-voices-2" class="{{count($data->voices) === 1 ? 'single' : ''}} main-color-background">
            @php
                \App\BrandBookCreator\BrandBookHelper::pageNumber($page_number);
            @endphp
            <div
            ...
            <div class="voices-wrapper">
                <div class="voices-wrap-left">
                    <h1 class="title {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
                        {{trans('themes.Brand_Archetype')}}
                    </h1>
                    <div
                            class="voices-text {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{trans('themes.archetype_text')}}</div>
                </div>
                @if(count($data->voices) == 2)
                    <div class="voices-images">
                        <div class="archetype-image-wrap">
                            ...
                            @if(empty($data->voices[1]))
                                <div
                                        class="archetype-name {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{$data->voices[0]}}</div>@endif
                        </div>
                        @if(!empty($data->voices[1]))
                            <div
                                    class="archetype-image-wrap {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
        ...
        <div id="page-voices-1" class="{{count($data->voices) === 1 ? 'single' : 'double'}} main-color-background">
            @php
                \App\BrandBookCreator\BrandBookHelper::pageNumber($page_number);
            @endphp
            <div
            ...
            <div class="voices-wrapper">
                <div class="voices-images">
                    <div class="archetype-image-wrap">
                        ...
                        @if(empty($data->voices[1]))
                            <div
                                    class="archetype-name {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{$data->voices[0]}}</div>
                        @endif
                    </div>
                    @if(!empty($data->voices[1]))
                        <div class="archetype-image-wrap">
                ...
                <div class="voices-description">
                    ...
                    <div class="archetype-descritpion">
                        @if(!empty($data->voices[1]))
                            <div
                                    class="voices-names {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
                                {{$data->voices[0]}}
                            </div>
                        @endif
                        <p class="{{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{!! \App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[0]]['description']!!}</p>
                        <div
                                class="voices-descritpion-short {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{\App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[0]]['short_description']}}</div>
                    </div>
                    @if(!empty($data->voices[1]))
                        <div class="and {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
                            &
                        </div>
                        <div class="archetype-descritpion">
                            <div
                            ...
                            <p class="{{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{\App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[1]]['description']}}</p>
                            <div
                                    class="voices-descritpion-short {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{\App\BrandBookCreator\BrandBookHelper::ARCHETYPES[$data->voices[1]]['short_description']}}</div>
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    @foreach($chunk as $logo)
                        <div class="logo-var-background"
                            ...
                            <div class="logo-variation"
                                 style="background-image: url({{$logo->logo_b64}});background-repeat: no-repeat;background-position: center;background-size: contain"></div>
                            <span
    ...
    @if($data->icon!='skipped' && !empty($data->icon) && $data->icon!='[]')
        ...
        <div id="page17" class="white-background">
            ...
            <div class="logo-wrapper">
                <img src="{!! $data->icon_b64 !!}" style="height: 200px;margin-top: 50px; width: 200px;">
                <div
...
border-top: 1px solid white; border-bottom: 1px solid white;">
        ...
        <div class="bottom-left">
            ...
            <div class="text" data-field="space_text" style="position: relative;z-index: 2">
                @if(!empty($data->space_text))
                    {!!$data->space_text!!}
                @else
                    <p>{!! trans('themes.clear_space_text', ['brand' => $data->brand]) !!}
                        @endif</p>
            </div>
        </div>
        @if($data->watermark)
    ...
    <div id="page26" class="white-background">
        ...
        <div class="page-padding-wrapper">
            ...
            <div class="tertiary-color-box tertiary-color-background">
                <p class="color-name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($tertiary_color)}}">{{trans('themes.tertiary_color')}}</p>
                <p class="color-hex" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($tertiary_color)}}">{{$tertiary_color}}</p>
            </div>
    ...
    <div id="page27-27" style="position: relative;" class="white-background">
        ...
        <div class="secondary-color-box secondary-color-background">
            <p class="color-name"
               style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($secondary_color)}}">{{trans('themes.secondary_color')}}</p>
            <p class="color-hex"
               style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($secondary_color)}}">{{$secondary_color}}</p>
        </div>

        <div class="main-color-box main-color-background">
            <p class="color-name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color)}}">{{trans('themes.primary_color')}}</p>
            <p class="color-hex" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color)}}">{{$main_color}}</p>
        </div>
        @if($data->watermark)
            <img class="watermark-draft" src="{{$watermark}}">
        @endif
        ...
        @foreach($data->colors_list as $index => $color)
            ...
            <div class="detail-color-box" style="background: {{$color->color->hex->value}};">
                <div class="left-block">
                    <div class="text-color-type" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{$color_names[$index]}}</div>
                    <div class="text-color-name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{$color->color->name->value}}</div>
                    <div class="color-description">
                        <div class="name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">Hex</div>
                        <div class="value" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{$color->color->hex->value}}</div>
                        <div class="name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">RGB</div>
                        <div
                                class="value" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{$color->color->rgb->r}} {{$color->color->rgb->g}} {{$color->color->rgb->b}}</div>
                        <div class="name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">CMYK</div>
                        <div
                                class="value" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{$color->color->cmyk->c}} {{$color->color->cmyk->m}} {{$color->color->cmyk->y}} {{$color->color->cmyk->k}}</div>
                        @if(property_exists($color, 'pantone') && $color->pantone!=null)
                            <div class="name" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{trans('themes.pantone')}}</div>
                            <div class="value" style="color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($color->color->hex->value)}}">{{$color->pantone->getName()}}</div>
                        @endif
                    </div>
                </div>
