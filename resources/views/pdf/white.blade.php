...
<head>
	...
	stroke: #fff !important;*/
      ...
      flex: 1;*/
        ...
        #page11 .core-values .core-value .text, #page10 .core-values .core-value .text {
            font-size: {{18-$text_length/200}}px;
        }
...
!empty($data->introduction_title) ? $data->introduction_title : trans('themes.introduction') !!}</h1>
    ...
    @if(!empty($data->vision_text) || !empty($data->vision))
        ...
        <div id="page7" style="">
            ...
            <div class="text autosize" data-field="vision_text"><div>
...
<div id="page27-27" style="position: relative;">
    ...
    <div class="svg-block" style="position: absolute;top: 0;
        ...
        <span class="cp1"
              style="position: absolute;display: block;top: 280px;left: 350px;text-transform: uppercase;font-size: 32px; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[0]->id)}};">{{$data->colors_list[0]->id}}</span>
        <span class="cp2"
              style="position: absolute;display: block;top: 240px;left: 680px;text-transform: uppercase;font-size: 24px; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[1]->id)}};">{{$data->colors_list[1]->id}}</span>
        <span class="cp3"
              style="position: absolute;display: block;top: 360px;left: 160px;text-transform: uppercase;font-size: 20px; color: {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($data->colors_list[2]->id)}};">{{$data->colors_list[2]->id}}</span>
