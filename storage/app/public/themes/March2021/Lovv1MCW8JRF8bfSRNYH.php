        ...
        <div id="page25">
            ...
            @foreach($data->missuses as $missuse)
                <div class="rejected_item">
                    <div class="logo-image"
                         style="@foreach($missuse->style as $key=>$value) {{from_camel_case_2($key)}}: @if($value=='rotate(45deg)') rotate(20deg) @else{{$value}}@endif;@endforeach background-image: url({{$missuse->logo_b64}})"></div>
    ...
    <div id="page26">
        ...
        <div class="text" data-field="pallette_text" style="border-bottom: 1px solid #000;">
            @if(!empty($data->pallette_text))
                {!!$data->pallette_text!!}
            @else
                <p>T{{trans('themes.the_colors_selected', ['brand' => $data->brand])}}
                </p>
            @endif
        </div>
                            ...
                            <div class="color-block-color" style="margin-top: 5px">
                                ...
                                <div class="sub-colors"
                                    ...
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 14px;background: {{adjustBrightness_2($color->color->hex->value, -30)}}; flex-basis: 25%; border-bottom-left-radius: 5px; border-right: 1px solid #fff;color: {{getContrastColor_2(adjustBrightness_2($color->color->hex->value, -30))}}">
                                        +30% Black
                                    </div>
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 14px;background: {{$color->color->hex->value}}; flex-basis: 25%; border-right: 1px solid #fff; border-left: 1px solid #fff;color: {{getContrastColor_2($color->color->hex->value)}}">
                                        100%
                                    </div>
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 14px;background: {{adjustBrightness_2($color->color->hex->value, 30)}}; flex-basis: 25%; border-right: 1px solid #fff;border-left: 1px solid #fff;color: {{getContrastColor_2(adjustBrightness_2($color->color->hex->value, 30))}}">
                                        70%
                                    </div>
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 14px;background: {{adjustBrightness_2($color->color->hex->value, 40)}}; flex-basis: 25%; border-bottom-right-radius: 5px; border-left: 1px solid #fff;color: {{getContrastColor_2(adjustBrightness_2($color->color->hex->value, 40))}}">
                                        40%
                                    </div>
                                </div>
                                <div class="sub-colors-text"
                                    ...
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 10px;flex-basis: 25%; text-align:center; border-right: 1px solid #fff;">{{adjustBrightness_2($color->color->hex->value, -30)}}</div>
                                    <div class="sub-color-item"
                                    ...
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 10px; flex-basis: 25%; border-right: 1px solid #fff;border-left: 1px solid #fff;text-align:center;">{{adjustBrightness_2($color->color->hex->value, 30)}}</div>
                                    <div class="sub-color-item"
                                         style="text-align: center; font-size: 10px; flex-basis: 25%; border-bottom-right-radius: 5px; border-left: 1px solid #fff;text-align:center;">{{adjustBrightness_2($color->color->hex->value, 40)}}</div>
                                </div>
                            </div>
        ...
        <div class="svg-block" style="position: absolute;left: 427px;top: 0;">
            <svg width="696" height="356" viewBox="0 0 696 356" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="223.001" y="317.461" width="314.988" height="314.988" transform="rotate(-135 223.001 317.461)"
                      fill="@if(isset($data->colors_list[1]) && isset($data->colors_list[1]->id)){{adjustBrightness_2($data->colors_list[1]->id, -40)}}@endif"/>
