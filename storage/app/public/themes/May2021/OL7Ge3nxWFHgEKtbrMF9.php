        ...
        <div id="page-voices-2" class="{{count($data->voices) === 1 ? 'single' : ''}} main-color-background">
            ...
            <div class="voices-wrapper">
                <div class="voices-wrap-left">
                    ...
                    <div class="voices-text {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{trans('themes.archetype_text')}}</div>
                </div>
                    ...
                    <div class="voices-images">
                        <div class="archetype-image-wrap">
                            ...
                            @if(empty($data->voices[1]))
                                <div class="archetype-name {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{$data->voices[0]}}</div>@endif
                        </div>
                        @if(!empty($data->voices[1]))
                            <div class="archetype-image-wrap {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
            ...
            <div class="voices-wrapper">
                <div class="voices-images">
                    <div class="archetype-image-wrap">
                        {!! \App\BrandBookCreator\BrandBookHelper::getSVG_src($data->voices[0]) !!}
                        @if(empty($data->voices[1]))
                            <div class="archetype-name {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">{{$data->voices[0]}}</div>
                        @endif
                    </div>
                    @if(!empty($data->voices[1]))
                        <div class="archetype-image-wrap">
                ...
                <div class="voices-description">
                    ...
                    <div class="archetype-descritpion">
                        @if(!empty($data->voices[1]))
                            <div class="voices-names {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
                                {{$data->voices[0]}}
                            </div>
                        @endif
                    ...
                    @if(!empty($data->voices[1]))
                        <div class="and {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">&</div>
                        <div class="archetype-descritpion">
                            <div class="voices-names {{\App\BrandBookCreator\BrandBookHelper::getContrastColor($main_color, true)}}">
                                {{$data->voices[1]}}
                            </div>
    ...
    @if($data->icon!='skipped' && !empty($data->icon) && $data->icon!='[]')
        ...
        <div id="page17" class="white-background">
            ...
            <div class="logo-wrapper">
                <img src="{!! $data->icon_b64 !!}" style="height: 250px;">
                <div
