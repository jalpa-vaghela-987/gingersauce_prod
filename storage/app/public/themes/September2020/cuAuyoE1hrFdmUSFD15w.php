@php
    function from_camel_case_2($input) {
...
<div class="grey-theme">
    ...
    <div id="page4">
        ...
        <div class="svg-block" style="position: absolute;    position: absolute;left: 0;bottom: 0;width: 373px;height: 321px;">
            <svg width="373" height="321" viewBox="0 0 373 321" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="78.6797" y="342.716" width="51" height="51" transform="rotate(-143.084 78.6797 342.716)" fill="#C4C4C4"/>
                <rect x="3.04883" y="290.902" width="51" height="51" transform="rotate(-143.084 3.04883 290.902)" fill="#C4C4C4"/>
                <rect x="206.92" y="324.5" width="41" height="41" transform="rotate(-143.084 206.92 324.5)" fill="#C4C4C4"/>
                <rect x="133.092" y="270.288" width="41" height="41" transform="rotate(-143.084 133.092 270.288)" fill="#C4C4C4"/>
                <rect x="58.0625" y="217.674" width="41" height="41" transform="rotate(-143.084 58.0625 217.674)" fill="#C4C4C4"/>
                <rect x="-18.1699" y="166.659" width="41" height="41" transform="rotate(-143.084 -18.1699 166.659)" fill="#C4C4C4"/>
                <rect x="335.16" y="306.285" width="28" height="28" transform="rotate(-143.084 335.16 306.285)" fill="#C4C4C4"/>
                <rect x="261.934" y="251.272" width="28" height="28" transform="rotate(-143.084 261.934 251.272)" fill="#C4C4C4"/>
                <rect x="188.705" y="196.26" width="28" height="28" transform="rotate(-143.084 188.705 196.26)" fill="#C4C4C4"/>
                <rect x="115.477" y="141.248" width="28" height="28" transform="rotate(-143.084 115.477 141.248)" fill="#C4C4C4"/>
                <rect x="42.25" y="86.2354" width="28" height="28" transform="rotate(-143.084 42.25 86.2354)" fill="#C4C4C4"/>
            </svg>
        ...
        <div id="page6" style="background: #d4d4d4">
            ...
            <div class="svg-block">
                <svg width="431" height="525" viewBox="0 0 431 525" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="300.604" height="300.604" transform="matrix(0.40982 0.912166 -0.930432 0.366465 191.275 58.3196)" fill="@if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id)) {{$data->colors_list[0]->id}} @endif"/>
                    <rect width="59.3226" height="59.3226" transform="matrix(0.961795 0.273772 0.300949 -0.95364 336.096 126.071)" fill="white"/>
                </svg>
    ...
    @if(!empty($data->mission_text) || !empty($data->mission))
        <div id="page8">
            ...
            <div class="svg-block" style="position: absolute; left: 0; top: 0;">
                <svg width="458" height="340" viewBox="0 0 458 340" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="154.136" cy="36.8636" r="303.136" fill="#c7c7c7"/></svg>
        ...
        <div id="page9">
            ...
            <div class="svg-block" style="position: absolute;right: 0;bottom: 0;">
                <svg width="372" height="232" viewBox="0 0 372 232" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="38.5" cy="61.5" r="38.5" fill="#c7c7c7"/><circle cx="271" cy="170.5" r="170.5" fill="@if(isset($data->colors_list[1]) && isset($data->colors_list[1]->id)){{$data->colors_list[1]->id}}@endif"/></svg>
    ...
    @if(count($data->core_values)>0)
        <div id="page10">
            ...
            <div class="svg-block" style="position: absolute;left: 0;top: 0;height: 760px;width: 760px">
                <svg width="760" height="760" viewBox="0 0 760 760" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="0" cy="380" r="760" fill="@if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id)) {{$data->colors_list[0]->id}} @endif"/></svg>

            </div>
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="core_title" style="position: relative;z-index: 2;color: #fff;">{{!empty($data->core_title) ? $data->core_title : 'Core Values'}}</h1>
            <div class="text" data-field="core_text" style="position: relative;z-index: 2;color: #fff;border-bottom: 1px solid #fff;">
    ...
    <div id="page12">
        ...
        {{-- <div class="gradient-block"></div> --}}
        <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="logo_title">{{!empty($data->logo_title) ? $data->logo_title : 'Our Logo'}}</h1>
    ...
    @if(count($data->approved)>0)
        ...
        <div id="page15">
            ...
            @endphp
            <div class="svg-block" style="position: absolute;left: 0;top: 0;">
                <svg width="760" height="760" viewBox="0 0 857 840" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="838.5" cy="420" rx="838.5" ry="838" fill="{{$background}}"/></svg>
            </div>
            <div class="page-number right text-white">{{$page_number}}</div>
    ...
    @endif
    <div id="page16-1" class="{{(!$approved_primary_color || !$approved_secondary_color) ? 'page16-oneside' : ''}}" style="background: #C4C4C4">
        @php
            $page_number++;
        @endphp
        <div class="page-number">{{$page_number}}</div>
        <div class="svg-block" style="position: absolute;left: 0;top: 0">
            <svg width="760" height="760" viewBox="0 0 874 840" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    @if($data->icon!='skipped' && !empty($data->icon) && $data->icon!='[]')
        <div id="page16">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="icon_title" style="border-bottom: 1px solid #000; margin-bottom: 50px">{{!empty($data->icon_title) ? $data->icon_title : 'Our Icon & Favicon'}}</h1>
            ...
            @if(isset($data->icon_b64))
                <div class="favicon">
                    <div class="logo-img" style="background-color: {{isset($data->approved_icon[0]->background)?$data->approved_icon[0]->background:'transparent'}};background-image: url({{isset($data->icon_b64)?$data->icon_b64:''}});background-repeat: no-repeat;background-position: center;background-size: contain; height: 60px;"></div>
                    <div class="logo-title"">
...
<div id="page18">
    ...
    <div class="background">
        <svg width="616" height="473" viewBox="0 0 616 473" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0-18)"><path d="M500.514 588.216L500.514 28.6936" stroke="#DADADA" stroke-width="4.78224"/><path d="M501.04 4.78223L488.615 47.8224L513.465 47.8224L501.04 4.78223Z" fill="#DADADA"/><path d="M615.814 4.52539L457.474 4.51841" stroke="#DADADA" stroke-width="4.78224"/></g><path d="M411.457 353L388.105 318.052L365.075 353H328.678L369.746 295.988L330.449 240.265H366.364L388.91 272.797L411.135 240.265H445.6L406.304 294.7L448.177 353H411.457Z" fill="#DADADA"/><rect width="0.972566" height="442.596" transform="matrix(-1.36483e-07 -1 -1 1.39994e-08 442.598 5.66211)" fill="black"/><defs><clipPath id="clip0-18"><rect x="615.814" width="616.909" height="157.814" transform="rotate(90 615.814 0)" fill="white"/></clipPath></defs></svg>
    </div>
</div>
...
<div id="page22" style="padding: 280px 190px;background: #93989B">
    ...
    <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="size_title" style="color: #fff">{{!empty($data->size_title) ? $data->size_title :'Minimum Size'}}
    </h1>
...
<div id="page24">
    ...
    <h1 class="title text-white" contenteditable="true" @blur="title_changed()" data-title-field="misuse_title" style="color: #000;">{{!empty($data->misuse_title) ? $data->misuse_title : 'Logo Misuse'}}</h1>
...
<div id="page25">
    ...
    @foreach($data->missuses as $missuse)
        <div class="rejected_item">
            <div class="logo-image" style="@foreach($missuse->style as $key=>$value) {{from_camel_case_2($key)}}: @if($value=='rotate(45deg)') rotate(20deg) @else{{$value}}@endif;@endforeach background-image: url({{$missuse->logo_b64}})"></div>
...
@if(count($data->icon_family)>0)
    <div id="page26-1" style="padding: 90px;">
        ...
        @endphp
        <div class="page-number">{{$page_number}}</div>
        <h1 class="title">Feature Icons</h1>
...
<div id="page27-27" style="position: relative;">
    ...
    @if(isset($data->colors_list[0])) <div class="primary-color" style="width: 380px;height: 760px;position: absolute; left: 0; top: 0;background: {{$data->colors_list[0]->id}}"><div class="color-code" style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm;transform: rotate(90deg);transform-origin: left top;top: 10mm;left: 15mm;">{{$data->colors_list[0]->id}}</div></div> @endif
    @if(isset($data->colors_list[1])) <div class="secondary-color" style="width: 280px;height: 760px;position: absolute; right: 100px; bottom: 0;background: {{$data->colors_list[1]->id}}"><div class="color-code" style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm;transform: rotate(90deg);transform-origin: left top;top: 10mm;left: 15mm;">{{$data->colors_list[1]->id}}</div></div> @endif
    @if(isset($data->colors_list[2])) <div class="tratiary-color" style="width: 100px;height: 760px;position: absolute; right: 0; top: 0;background: {{$data->colors_list[2]->id}}"><div class="color-code" style="font-style: italic;font-weight: 600;font-size: 38px;line-height: 26px;color: #FFFFFF;position: absolute; bottom: 10mm;left: 10mm;transform: rotate(90deg);transform-origin: left top;top: 10mm;left: 15mm;">{{$data->colors_list[2]->id}}</div></div> @endif
</div>
<div class="page-break pb27-27"></div> 		@php
    function adjustBrightness_2($hex, $steps) {
			...
			function getContrastColor_2($bg)
			{
        ...
        @foreach($data->colors_list as $c=>$color)
            @if($c<$cllimit && $c>=$cloffset)
                @if(isset($color->color))
                    <div class="color-block" style="margin-bottom: 20px;flex-basis: 100%;" {{--style="@if($c<2) margin-top:42px; @endif"--}}>
                        <div class="color-block-header" style="display: flex; justify-content: space-between;">
                            <div class="color-block-title" style="flex-basis: 180px">
                                ...
                                <div class="title" style="color: #000; font-size: 13px;">{{$color->color->name->value}}</div>
                            </div>
                            <div class="color-block-info" style="display: flex; flex-basis: 50%; justify-content: space-between;">
                        ...
                        <div class="color-block-color" style="margin-top: 5px">
                            <div class="main-color" style="widows: 100%; border-top-right-radius: 5px; border-top-left-radius: 5px; background: {{$color->color->hex->value}};border-bottom: 2px solid #fff;height: 30px;@if(!$color->show_shades) height: 50px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; border-bottom: 0; @endif"></div>
                            <div class="sub-colors" style="@if($color->show_shades) display: flex;flex-wrap: nowrap; @else display: none; @endif height: 20px;">
                                <div class="sub-color-item" style="text-align: center; font-size: 14px;background: {{adjustBrightness_2($color->color->hex->value, -30)}}; flex-basis: 25%; border-bottom-left-radius: 5px; border-right: 1px solid #fff;color: {{getContrastColor_2(adjustBrightness_2($color->color->hex->value, -30))}}">+30% Black</div>
                                <div class="sub-color-item" style="text-align: center; font-size: 14px;background: {{$color->color->hex->value}}; flex-basis: 25%; border-right: 1px solid #fff; border-left: 1px solid #fff;color: {{getContrastColor_2($color->color->hex->value)}}">100%</div>
                                <div class="sub-color-item" style="text-align: center; font-size: 14px;background: {{adjustBrightness_2($color->color->hex->value, 30)}}; flex-basis: 25%; border-right: 1px solid #fff;border-left: 1px solid #fff;color: {{getContrastColor_2(adjustBrightness_2($color->color->hex->value, 30))}}">70%</div>
                                <div class="sub-color-item" style="text-align: center; font-size: 14px;background: {{adjustBrightness_2($color->color->hex->value, 40)}}; flex-basis: 25%; border-bottom-right-radius: 5px; border-left: 1px solid #fff;color: {{getContrastColor_2(adjustBrightness_2($color->color->hex->value, 40))}}">40%</div>
                            </div>
                            <div class="sub-colors-text" style="display: flex;flex-wrap: nowrap;@if(!$color->show_shades) opacity: 0; @endif margin-top: 5px;">
                                <div class="sub-color-item" style="text-align: center; font-size: 10px;flex-basis: 25%; text-align:center; border-right: 1px solid #fff;">{{adjustBrightness_2($color->color->hex->value, -30)}}</div>
                                <div class="sub-color-item" style=" text-align: center; font-size: 10px;flex-basis: 25%; text-align:center;border-right: 1px solid #fff; border-left: 1px solid #fff;">{{$color->color->hex->value}}</div>
                                <div class="sub-color-item" style="text-align: center; font-size: 10px; flex-basis: 25%; border-right: 1px solid #fff;border-left: 1px solid #fff;text-align:center;">{{adjustBrightness_2($color->color->hex->value, 30)}}</div>
                                <div class="sub-color-item" style="text-align: center; font-size: 10px; flex-basis: 25%; border-bottom-right-radius: 5px; border-left: 1px solid #fff;text-align:center;">{{adjustBrightness_2($color->color->hex->value, 40)}}</div>
                            </div>
                        </div>
...
<div id="page27" class="@if(count($data->colors_list)<5) colors-4 @endif">
    ...
    @else
        ...
        @endphp
    @endif
    <div class="color-blocks" style="height: 650px;align-items: center;display: flex;flex-wrap: wrap;padding-top: 75px;">
        @foreach($data->colors_list as $c=>$color)
            @if($c<$cllimit && $c>=$cloffset)
                @if(isset($color->color))
                    <div class="color-block" style="margin-bottom: 20px;flex-basis: 100%;" {{--style="@if($c<2) margin-top:42px; @endif"--}}>
...
<div id="page28" style="background: #e0DDDD;">
    ...
    @if(isset($data->fonts_main[1]))
        <div class="huge-text text-one" style="border: none">
            <div style="height: 400px;width: 932px;position: absolute;color: #fff;left: -36px;top: -155px;font-size: 200px;font-weight: 900;line-height: 200px;"><div style="position: absolute;right: 0;bottom: 0;font-family: 'main1';width: 1072px;text-align: right;">{{$data->fonts_main[1]['font_face']}}</div></div>
            @if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id))
                <div class="color" style="position: absolute;color: {{$data->colors_list[0]->id}};top: 230px;left: 235px;font-weight: 800;text-transform: uppercase;font-size: 50px;">
                    {{$data->colors_list[0]->id}}
                </div>
            @endif
            <small class="color-subtext" style="color: #fff;color: #fff;position: absolute;left: 280px;top: 310px;width: 420px;     white-space: unset;display: block;">
                <svg width="155" height="99" viewBox="0 0 155 99" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M153.001 96.6665H96.3169L1.54883 1.89844" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<div id="page29" style="background: #e0dddd; padding-top: 440px;">
    ...
    @if(isset($data->fonts_main[1]))
        <div class="huge-text text-one" style="border: none">
            <div style="height: 400px;width: 932px;position: absolute;color: #fff;left: -751px;top: -110px;font-size: 200px;font-weight: 900;line-height: 200px;font-family: 'main1'"><div style="position: absolute;right: 0;bottom: 0;font-family: 'main1';width: 1072px;text-align: right;">{{$data->fonts_main[1]['font_face']}}</div></div>
            <small class="color-subtext" style="color: @if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id)) {{$data->colors_list[0]->id}} @endif;position: absolute;left: 200px;top: 200px;width: 460px;     white-space: unset;display: block;">
                <svg width="170" height="4" viewBox="0 0 170 4" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0.572266" y="0.945312" width="168.449" height="3" fill="@if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id)) {{$data->colors_list[0]->id}} @endif"/></svg>
    ...
    @foreach($data->fonts_main as $fm)
        @if(isset($fm['index']))
            <div style="display: flex; flex-wrap: nowrap; margin-bottom: 20px; align-items: center;">
                <div style="border: 1px solid #000000;font-family: 'main{{$fm['index']}}';padding: 12px; margin-right: 40px;width: 131px; box-sizing: border-box;height: 153px;text-align: center;">
...
<div id="page31">
    ...
    @foreach($data->fonts_secondary as $fs)
        @if(isset($fs['index']))
            <div style="display: flex; flex-wrap: nowrap; margin-bottom: 20px; align-items: center;">
                <div style="border: 1px solid #000000;font-family: 'second{{$fs['index']}}';padding: 12px; margin-right: 40px;width: 131px; box-sizing: border-box;height: 153px;text-align: center;">
...
<div id="page32">
    ...
    <h1 class="title ">Brand Book Designer</h1>
    <div class="text ">
...
<div id="page35" style="@if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id)) background: {{$data->colors_list[0]->id}}; @endif">
    @php
        $page_number++;
    @endphp
    <div class="page-number right text-white">{{$page_number}}</div>
