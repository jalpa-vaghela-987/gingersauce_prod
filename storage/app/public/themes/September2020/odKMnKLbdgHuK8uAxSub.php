@php
    function from_camel_case_3($input) {
...
#page15 .logo-versions .logo-version .logo-img,#page15 .logo-versions .logo-version .logo-title{
	width: 100%;
        ...
        #page16 .favicon .logo-img, #page17 .favicon .logo-img, , #page27-1 .favicon .logo-img{
                                                                      height: 70px;
                                                                      width: 70px;
                                                                      margin-left: 50px;
                                                                      background-size: contain;
...
<div class="white-theme">
    ...
    <div id="page2">
        @if(isset($data->icon) && $data->icon!='skipped')
            {!!$data->icon!!}
        @endif
    </div>
    ...
    <div id="page3">
        ...
        <div class="contents">
            ...
            @if(count($data->icon_family)>0)
                ...
                @endphp
                <div class="content-item">
                    <div><a -href="#Color Palette">Feature Icons</a></div>
                    <div class="dots"></div>
                    <div class="page">{{$page_number_sm}}</div>
                </div>
            @endif
            ...
            @endphp
            <div class="content-item">
                <div><a -href="#Color Palette">Color Palette</a></div>
                <div class="dots"></div>
                <div class="page">{{$page_number_sm}}</div>
            </div>
            @php
    ...
    <div id="page5">
        ...
        <div class="svg-block" style="position: absolute;    position: absolute;left: -294px;bottom: 0;width: 1128px;height: 476px;">
            <svg width="1128" height="476" viewBox="0 0 1128 476" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.7492 42.0233H207.889V53.9926H173.241V471.031H207.889V483H15.7492V471.031H50.3973V53.9926H15.7492V42.0233ZM231.493 183.136H383.315V241.093C390.035 221.774 400.324 206.235 414.183 194.475C428.043 182.716 449.042 176.836 477.18 176.836C542.277 176.836 574.825 211.904 574.825 282.041V471.661H610.103V483H431.823V471.661H457.651V266.921C457.651 241.723 455.971 225.554 452.611 218.414C449.252 210.854 443.162 207.075 434.342 207.075C420.903 207.075 408.934 215.894 398.434 233.533C388.355 251.172 383.315 272.591 383.315 297.79V471.661H410.404V483H231.493V471.661H266.141V194.475H231.493V183.136ZM646.848 392.915V194.475H612.2V183.136H646.848V101.87L764.022 72.8916V183.136H845.917V194.475H764.022V406.774C764.022 426.513 765.912 441.002 769.691 450.242C773.891 459.481 782.291 464.101 794.89 464.101C807.489 464.101 818.409 457.801 827.648 445.202C837.308 432.603 843.607 415.384 846.547 393.545L857.257 394.805C853.897 423.783 844.657 446.882 829.538 464.101C814.419 480.9 789.43 489.3 754.572 489.3C719.714 489.3 693.045 482.37 674.566 468.511C656.087 454.651 646.848 429.453 646.848 392.915ZM1073.68 200.775C1058.15 200.775 1044.5 210.854 1032.74 231.013C1020.98 251.172 1015.1 275.111 1015.1 302.83V471.661H1059.83V483H863.276V471.661H897.924V194.475H863.276V183.136H1015.1V243.613C1020.56 222.194 1031.06 205.815 1046.6 194.475C1062.14 182.716 1079.77 176.836 1099.51 176.836C1119.25 176.836 1135.21 182.506 1147.39 193.845C1159.99 204.765 1166.29 220.514 1166.29 241.093C1166.29 261.252 1161.67 276.791 1152.43 287.71C1143.19 298.63 1128.91 304.089 1109.59 304.089C1090.69 304.089 1076.62 297.79 1067.39 285.19C1058.57 272.591 1057.52 255.162 1064.24 232.903H1086.91C1097.41 211.484 1093 200.775 1073.68 200.775ZM209.779 841.897V788.349C209.779 747.612 207.469 718.003 202.849 699.524C198.65 680.625 188.57 671.176 172.611 671.176C163.371 671.176 155.812 673.905 149.932 679.365C144.472 684.405 140.483 693.014 137.963 705.194C134.183 724.093 132.293 752.861 132.293 791.499V840.637C132.293 886.414 133.553 913.923 136.073 923.162C139.013 932.402 141.953 939.961 144.892 945.841C149.512 955.921 158.542 960.96 171.981 960.96C188.36 960.96 199.069 951.511 204.109 932.612C207.889 919.172 209.779 888.934 209.779 841.897ZM170.721 972.3C118.224 972.3 78.5359 958.86 51.6573 931.982C24.7787 905.103 11.3394 866.675 11.3394 816.698C11.3394 766.301 25.6186 727.663 54.1771 700.784C83.1556 673.485 123.683 659.836 175.761 659.836C227.838 659.836 266.686 672.435 292.305 697.634C317.923 722.413 330.733 760.421 330.733 811.658C330.733 918.752 277.395 972.3 170.721 972.3Z" fill="#EAEAEA"/>
            </svg>

        </div>
        <h1 class="title" contenteditable="true" data-title-field="introduction_title" style="position: relative;z-index: 2">{{!empty($data->introduction_title) ? $data->introduction_title : 'Introduction'}}</h1>
        ...
        @if(!empty($data->mockups[0]->title))
            <div id="page-mockup-1-0">
                ...
                <div class="mockup-wrapper">
                    ...
                    <div class="mockup-photo mockup-photo-left-half" style="background-image: url({{$data->mockups[0]->image}})"></div>
                </div>
            </div>
            <div id="page-mockup-1-1">
                ...
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-right-full-left-half" style="background-image: url({{$data->mockups[0]->image}})"></div>
                </div>
            </div>
        @else
            <div id="page-mockup-1-0">
                ...
                <div class="page-number">{{$page_number}}</div>
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-left-full" style="background-image: url({{$data->mockups[0]->image}})"></div>
                </div>
            </div>
            <div id="page-mockup-1-1">
                @php
                ...
                <div class="page-number right">{{$page_number}}</div>
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-right-full" style="background-image: url({{$data->mockups[0]->image}})"></div>
                </div>
            </div>
        @endif
    @endif
    ...
    @if(!empty($data->vision_text) || !empty($data->vision))
        <div id="page6" style="">
            ...
            <div class="svg-block">
                <svg width="1433" height="840" style="height: 760px; width: auto;" viewBox="0 0 1433 840" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M468.751 286.418C511.7 -176.335 1060.21 -224.317 1009.6 -497.216C991.631 -537.971 927.229 -580.779 949.523 -470.73C996.914 -236.795 498.651 -156.944 463.159 286.119C441.385 557.935 23.9228 751.072 -210.423 935.227C-444.769 1119.38 -1.05275 1244.51 1.83308 1008.54C4.71894 772.577 443.856 554.644 468.751 286.418Z" fill="#DCDCDC"/>
                    <path d="M185.621 781.921C192.085 788.205 193.661 803.687 185.061 812.533C176.461 821.379 165.878 825.396 157.459 822.152C145.288 817.462 148.858 798.144 157.459 789.297C166.059 780.451 174.829 771.429 185.621 781.921Z" fill="#D7D7D7"/>
                </svg>
        ...
        <div id="page7" style="">
            ...
            {{-- <div class="gradient-block"></div> --}}
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="vision_title" style="color: #000;">{{!empty($data->vision_title) ? $data->vision_title : 'Vision'}}</h1>
    ...
    @if(!empty($data->mission_text) || !empty($data->mission))
        <div id="page8">
            ...
            <div class="svg-block" style="position: absolute; left: 675px; top: 0;">
                <svg width="933" height="838"  style="height: 760px; width: auto" viewBox="0 0 933 838" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M654.297 0.923793H988.191V24.6841H919.411V852.542H988.191V876.303H606.776V852.542H675.556V70.9541H670.554L482.972 876.303H326.655L106.56 67.2025H101.557V852.542H170.337V876.303H0.263532V852.542H69.0433V24.6841H0.263532V0.923793H337.91L504.232 644.953L654.297 0.923793Z" fill="#D7D7D7"/>
                </svg>
        ...
        <div id="page9">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="mission_title" style="position: relative;z-index: 2;color: #fff">{{!empty($data->mission_title) ? $data->mission_title : 'Mission'}}</h1>
            <div class="text" data-field="mission_text"  style="position: relative;z-index: 2;border-bottom: 1px solid #000;">
        ...
        <div id="page10">
            ...
            <div class="svg-block" style="position: absolute;left: 0;top: 0;">
                <svg width="350" height="200" viewBox="0 0 350 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M312.723 81.9922C314.77 86.1759 324.596 87.757 333.378 82.8827C342.159 78.0083 348.372 71.7341 349.009 66.4835C349.93 58.8934 335.823 60.2884 327.041 65.1627C318.26 70.037 309.305 75.0079 312.723 81.9922Z" fill="#D7D7D7"/>
                    <path d="M27.2876 198.452C-74.5194 187.01 -112.058 70.4339 -43.954 13.9607C17.6962 -33.8685 85.2355 61.6388 123.776 43.9352C185.657 15.5103 304.822 -17.1421 291.506 67.614C278.832 148.281 110.093 207.758 27.2876 198.452Z" fill="#EAEAEA"/>
                </svg>


            </div>
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="core_title" style="position: relative;z-index: 2;">{{!empty($data->core_title) ? $data->core_title : 'Core Values'}}</h1>
    ...
    <div id="page12">
        ...
        <div class="svg-block" style="position: absolute;left: 0;top: 298px;">
            <svg width="279" height="429" viewBox="0 0 279 429" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M-197.898 364.032C-75.7816 169.846 103.961 71.5237 211.424 51.446C224.045 49.0881 248.933 51.4176 254.862 83.1517C261.825 120.418 236.698 141.102 224.078 143.46C136.439 159.834 -14.2223 224.216 -128.267 366.734C-151.046 365.834 -174.33 364.932 -197.898 364.032Z" fill="#EAEAEA"/>
            </svg>

        </div>
        <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="logo_title" style="position: relative;z-index: 2">{{!empty($data->logo_title) ? $data->logo_title : 'Our Logo'}}</h1>
    ...
    @if(count($data->approved)>0)
            ...
            @if(count($data->logo_versions)==3)
                <div class="logo-versions" style="justify-content: space-between;">
                    <div class="logo-version">
                        <div class="logo-img" style="background-image: url({{$data->logo_versions[1]->logo_b64}})"></div>
                        <div class="logo-title">
                            {{$data->logo_versions[1]->title}}
                        </div>
                    </div>
                    <div class="logo-version">
                        <div class="logo-img" style="background-image: url({{$data->logo_versions[2]->logo_b64}})"></div>
                        <div class="logo-title">
        ...
        @php
            $background = $data->colors_list[0]->id;
        @endphp
        <div id="page15" style="background: {{$background}}">
            @php
                $page_number++;
            @endphp
            ...
            <div class="logo-versions" style="position: relative; z-index: 2;">
                ...
                @endphp
                @foreach($data->approved as $approved)
                    @if(!empty($approved->background) && $approved->background!='transparent' && $ccc<3)
                        @php
                            $ccc++;
                        @endphp
    ...
    @endif
    <div id="page16-1" class="{{(!$approved_primary_color || !$approved_secondary_color) ? 'page16-oneside' : ''}}">
        @php
            $page_number++;
        @endphp
        <div class="page-number">{{$page_number}}</div>

        @if($approved_primary_color && $approved_secondary_color) <div class="logo-versions-block" style="position: relative;z-index: 2">@endif
            @if($approved_primary_color)
                <div class="logo-versions" @if(!$approved_secondary_color) style="position: relative;z-index: 2" @endif >
                    @foreach($data->approved as $approved)
                        @if(!empty($approved->title) && $approved->title=='Primary Color Positive')
                            <div class="logo-version version" style="background: {{$approved->background}};padding-left: 20px;padding-right: 20px;">
                                <div class="logo-img" style="background-image: url({{$approved->logo_b64}})"></div>
                                <div class="logo-title @if($approved->background!='transparent' && $approved->background!='#ffffff') text-white @endif">
                                    {{$approved->title}}
                                </div>
            ...
            @endif
            @if($approved_secondary_color)
                <div class="logo-versions" @if(!$approved_primary_color) style="position: relative;z-index: 2" @endif>
                    @foreach($data->approved as $approved)
                        @if(!empty($approved->title) && $approved->title=='Secondary Color Positive')
                            <div class="logo-version version" style="background: {{$approved->background}};padding-left: 20px;padding-right: 20px;">
                                <div class="logo-img" style="background-image: url({{$approved->logo_b64}})"></div>
            ...
            @endif
            @if($approved_primary_color && $approved_secondary_color) </div> @endif
    </div>
    <div class="page-break pb16-1"></div>
    <div id="page17-1" style="background: #C4C4C4">
        @php
            $page_number++;
        @endphp
        <div class="page-number right">{{$page_number}}</div>
        <div class="logo-versions">
            ...
            @endphp
            @foreach($data->approved as $approved)
                @if(!empty($approved->title) && $approved->title=='Black & White Positive' && $c<3)
                    @php
                        $c++;
                    @endphp
                    <div class="logo-version version" style="background: {{$approved->background}};padding-left: 20px;padding-right: 20px;">
    ...
    @if(isset($data->mockups[1]))
        @if(!empty($data->mockups[1]->title))
            <div id="page-mockup-2-0">
                ...
                <div class="page-number">{{$page_number}}</div>
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-left-full-right-half" style="background-image: url({{$data->mockups[1]->image}})"></div>
                </div>
            </div>
            <div id="page-mockup-2-1">
                ...
                <div class="page-number right">{{$page_number}}</div>
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-right-half" style="background-image: url({{$data->mockups[1]->image}})"></div>
        ...
        @else
            <div id="page-mockup-2-0">
                ...
                <div class="page-number">{{$page_number}}</div>
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-left-full" style="background-image: url({{$data->mockups[1]->image}})"></div>
                </div>
            </div>
            <div id="page-mockup-2-1">
                @php
                ...
                <div class="page-number right">{{$page_number}}</div>
                <div class="mockup-wrapper">
                    <div class="mockup-photo mockup-photo-right-full" style="background-image: url({{$data->mockups[1]->image}})"></div>
                </div>
            </div>
        @endif
    @endif
    ...
    @if($data->icon!='skipped' && !empty($data->icon) && $data->icon!='[]')
        <div id="page16" style="padding: 470px 90px 90px">
            ...
            <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="icon_title" style="margin-bottom: 50px;text-align: center;position: relative;z-index: 2">{{!empty($data->icon_title) ? $data->icon_title : 'Our Icon & Favicon'}}</h1>
            ...
            @if(isset($data->icon_b64))
                <div class="favicon" style="margin-top: -150px;">
                    <div class="logo-img" style="background-color: {{isset($data->approved_icon[0]->background)?$data->approved_icon[0]->background:'transparent'}};background-image: url({{isset($data->icon_b64)?$data->icon_b64:''}});background-repeat: no-repeat;background-position: center;background-size: contain;height: 100px;width: 100px;margin: 0 auto; padding: 0;"></div>
                    <div class="logo-title"">
...
<div id="page17">
    ...
    {{--@if(isset($data->approved_icon[1]))
				<div class="favicon first">
					<div class="logo-img" style="background-color: {{isset($data->approved_icon[1]['background'])?$data->approved_icon[1]['background']:''}};@if(isset($data->approved_icon[1]['border_radius'])) border-radius: {{$data->approved_icon[1]['border_radius']}}@endif;">
						<div class="image" style="background-image: url({{isset($data->approved_icon[1]['icon_b64'])?$data->approved_icon[1]['icon_b64']:''}});background-repeat: no-repeat;background-position: center;"></div>
					</div>
					<div class="logo-title"">
						{{isset($data->approved_icon[1]['title'])?$data->approved_icon[1]['title']:''}}
					</div>
				</div>
			@endif
			@if(isset($data->approved_icon[2]))
				<div class="favicon second">
					<div class="logo-img" style="background-color: {{isset($data->approved_icon[2]['background'])?$data->approved_icon[2]['background']:''}};@if(isset($data->approved_icon[2]['border_radius'])) border-radius: {{$data->approved_icon[2]['border_radius']}}@endif;">
						<div class="image" style="background-image: url({{isset($data->approved_icon[2]['icon_b64'])?$data->approved_icon[2]['icon_b64']:''}});background-repeat: no-repeat;background-position: center;"></div>
					</div>
					<div class="logo-title"">
						{{isset($data->approved_icon[2]['title'])?$data->approved_icon[2]['title']:''}}
					</div>
				</div>
			@endif
			--}}
...
<div id="page18" style="padding-top: 450px;">
    ...
    <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="proportions_title" style="font-size: 52px">{{!empty($data->proportions_title) ? $data->proportions_title : 'Logo & Icon Proportions'}}
    </h1>
...
<div id="page19">
    ...
    @endphp
    <div class="page-number right">{{$page_number}}</div>
    <div class="logo" data-x="{{$proportions_x}}" data-y="{{$proportions_y}}" style="@if($ratio<1) width: {{290*$ratio}}px; height: 290px;margin-left: -{{290*$ratio/2}}px; @if(empty($data->icon) || $data->icon=='skipped' || $data->icon=='[]') top: 50%; margin-top: -145px; @endif @else width: 290px; height: {{290/$ratio}}px;margin-left: -145px; @if(empty($data->icon) || $data->icon=='skipped' || $data->icon=='[]') top: 50%; margin-top: -{{145/$ratio}}px; @endif  @endif" data-h="{{$data->logo_h}}px" data-w="{{$data->logo_w}}px">
...
<div id="page20">
    ...
    <div class="svg-block" style="position: absolute;left: 0;top: 0;">
        <svg width="472" height="307" viewBox="0 0 472 307" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M280.521 143.753C279.2 138.141 287.621 128.325 300.166 125.371C312.711 122.417 323.842 122.941 328.661 127.259C335.626 133.5 320.61 144.201 308.065 147.155C295.52 150.109 282.727 153.122 280.521 143.753Z" fill="#EAEAEA"/>
            <path d="M53.7897 63.3446C-37.411 160.474 18.6425 300.26 130.835 294.626C229.769 286.48 220.099 140.688 272.212 124.309C355.886 98.0094 499.387 26.9282 418.614 -40.1828C341.738 -104.056 127.968 -15.6559 53.7897 63.3446Z" fill="#D7D7D7"/>
        </svg>
    ...
    <div class="text" data-field="space_text" style="position: relative;z-index: 2">
        @if(!empty($data->space_text))
            {!!$data->space_text!!}
        @else
            <p>Clear space is the area surrounding the global signature and Icon that must be kept free of any elements, including text, graphics, borders, or other logos. The minimum clear space required for the preferred global signature is equal to &quot;x&quot;, or the height and width of the {{$data->brand}} Icon
                @endif</p>
    </div>
    @if(!empty($data->icon) && $data->icon!='skipped' && $data->icon!='[]')
        @php
        ...
        @endphp
        <div class="icon iconster space-{{$data->space}}" style="width: {{$data->icon_w}}px; height: {{$data->icon_h}}px;margin-left: -{{$data->icon_w/2}}px;bottom: {{60+110}}px; {{--top: {{$logo_fsy+60}}px--}}">
...
<div id="page21">
    ...
    @endphp
    <div class="view-block space-{{$data->space}}" style="position: relative;top:{{($data->logo_h>0?$data->logo_h/2+$free_space_y_h:1)+200}}px;@if($data->logo_w/$data->logo_h<1 && $data->logo_h>=100)transform:scale(.8)@endif @if(empty($data->icon) || $data->icon=='skipped' || $data->icon=='[]') top: 50%; margin-top: -{{$data->logo_h/2}}px; @endif">
        ...
        <div class="logo" style="    position: absolute;
            ...
            @if(isset($data->logo_b64))
                <div class="proportions_logo logo-image" style="width: {{$data->logo_w}}px;height: {{$data->logo_h}}px;background-image: url({{$data->logo_b64}})"></div>
            @endif
            @if($clear_space_text!=='')
...
<div id="page22" style="padding: 280px 170px;background: #fff">
    ...
    <div class="svg-block" style="position: absolute; text-align: center; left: 50%;top: 50%;margin-top: -90px;margin-left: -94px;">
        <svg width="189" height="180" viewBox="0 0 189 180" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M21.0816 139.818C47.3856 174.545 111.015 195.686 146.597 165.116C182.179 134.547 197.789 90.6891 183.794 49.9459C163.562 -8.95049 84.6183 -10.4704 49.0366 20.0993C13.4549 50.6689 -22.8315 81.844 21.0816 139.818Z" fill="#EAEAEA"/>
        </svg>

    </div>
    <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="size_title" style="position: relative;z-index: 2">{{!empty($data->size_title) ? $data->size_title :'Minimum Size'}}
    </h1>
    <div class="text" data-field="size_text" style="position: relative;z-index: 2">
        @if(!empty($data->size_text))
            {!!$data->size_text!!}
        @else
            <p>Establishing a minimum size ensures that the impact and legibility of the logo is not compromised in application.</p>
        @endif
    </div>
</div>
...
<div id="page23">
    ...
    <div style="display: flex; flex-wrap: nowrap;justify-content: center;align-items:  center; height: 570px;">
        <div class="lgo" style="text-align: center;margin: 0 20px;">
            <div class="logo" style="height: auto; margin: 0 auto; width: @if($data->size=='quark')71px;@endif @if($data->size=='neutron')100px;@endif @if($data->size=='atom')160px;@endif @if($data->size=='molecule')214px;@endif">
                @if(isset($data->logo_b64))
        ...
        @if(!empty($data->icon) && $data->icon!='skipped' && $data->icon!='[]')
            <div class="icn" style="text-align: center;margin: 0 20px;">
                <div class="icon" style="margin: 0 auto;height: auto;width: @if($data->size=='quark')10px;@endif @if($data->size=='neutron')14px;@endif @if($data->size=='atom')22px;@endif @if($data->size=='molecule')30px;@endif">
    ...
    @if(!empty($data->mockups[2]->title))
        <div id="page-mockup-3-0">
            ...
            <div class="mockup-wrapper">
                ...
                <div class="mockup-photo mockup-photo-left-half" style="background-image: url({{$data->mockups[2]->image}})"></div>
            </div>
        </div>
        <div id="page-mockup-3-1">
            ...
            <div class="page-number right">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-right-full-left-half" style="background-image: url({{$data->mockups[2]->image}})"></div>
            </div>
        </div>
    @else
        <div id="page-mockup-1-0">
            ...
            <div class="page-number">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-left-full" style="background-image: url({{$data->mockups[2]->image}})"></div>
            </div>
        </div>
        <div id="page-mockup-1-1">
            @php
            ...
            <div class="page-number right">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-right-full" style="background-image: url({{$data->mockups[2]->image}})"></div>
            </div>
        </div>
    @endif
@endif
...
<div id="page25">
    ...
    {{--@if($data->state == 'rebrand')
		...
		@if(isset($data->rejected) && is_array($data->rejected))
			@foreach($data->rejected as $rejected)
				@if(!empty($rejected->background) && $rejected->background!='transparent')
					@php
						$bg = new Mexitek\PHPColors\Color($rejected->background);
					@endphp
					<div class="rejected_item" style="background-color: {{$rejected->background}}">
						...
						<div class="title" @if($bg->isDark())style="color: #fff"@endif>{{$rejected->title}}</div>
						<div class="line"></div>
					</div>
				@else
					<div class="rejected_item" style="background-color: {{$rejected->background}}">
    ...
    @foreach($data->missuses as $missuse)
        <div class="rejected_item">
            <div class="logo-image" style="@foreach($missuse->style as $key=>$value) {{from_camel_case_3($key)}}: @if($value=='rotate(45deg)') rotate(20deg) @else{{$value}}@endif;@endforeach background-image: url({{$missuse->logo_b64}})"></div>
...
@if(count($data->icon_family)>0)
    <div id="page26-1" style="padding: 90px;padding-top: 300px;">
        ...
        @endphp
        <div class="page-number">{{$page_number}}</div>
        <h1 class="title" style="position: relative;z-index: 2">Feature Icons</h1>
        <div class="text" style="position: relative;z-index: 2">
            <p>Icons are the visual expression of our products, services or tools.<br>
                ...
                all icons should have consistent line weights and visual style.</p>
        </div>
        <div class="svg-block" style="position: absolute;left: 0;top: 50%;margin-top: -420px;">
            <svg width="425" height="840" viewBox="0 0 425 840" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M36.228 665.147C274.865 694.778 419.031 464.339 291.456 306.761C174.325 171.188 -27.9439 340.392 -107.267 281.84C-234.629 187.828 -490.931 54.2335 -502.841 243.395C-514.177 423.43 -157.868 641.047 36.228 665.147Z" fill="#D7D7D7"/>
            </svg>
    ...
    <div id="page27-1">
        ...
        @endphp
        <div class="page-number right">{{$page_number}}</div>
        <div class="favicons @if(count($data->icon_family)<5) favicons-1-4 @endif @if(count($data->icon_family)>=5 && count($data->icon_family)<10) favicons-5-9 @endif @if(count($data->icon_family)>=10) favicons-10-12 @endif" style="justify-content: center;">
            @foreach($data->icon_family as $ind=>$icon)
                <div class="favicon icon-{{$ind}}">
                    <div class="logo-img">
                        <div class="image" style="background-image: url({{isset($icon['b64'])?$icon['b64']:''}});background-repeat: no-repeat;background-position: center;background-size: contain;width: 100px;height: 100px;"></div>
                    </div>
...
<div id="page26" style="padding-top: 440px">
    ...
    <h1 class="title" contenteditable="true" @blur="title_changed()" data-title-field="pallette_title)">{{!empty($data->pallette_title) ? $data->pallette_title : 'Our Color Palette'}}</h1>
    <div class="text" data-field="pallette_text" style="">
        @if(!empty($data->pallette_text))
            {!!$data->pallette_text!!}
        @else
            <p>The colors selected for the {{$data->brand}} signature reflect the company's values. The colors have been specifically chosen to represent the brand and should not be altered under any circumstance.<br> For Printing instances, a Rich Black should be used for text with C40 M10 Y0 K100.</p>
        @endif
    </div>
...
<div id="page27-27" style="position: relative;">
    ...
    <div class="svg-block" style="position: absolute;top: 0;
        ...
        <svg width="849" height="638" viewBox="0 0 849 638" fill="none" xmlns="http://www.w3.org/2000/svg">
            @if(isset($data->colors_list[1]))<path d="M1023.04 -45.6976C1229.5 -61.843 1405.55 138.588 1324.47 267.179C1248.15 377.538 1033 226.759 974.436 273.346C880.411 348.146 679.707 451.621 630.001 291.076C582.694 138.278 855.12 -32.5659 1023.04 -45.6976Z" fill="{{$data->colors_list[1]->id}}"/>@endif
            @if(isset($data->colors_list[0]))<path d="M194.643 162.667C179.869 401.943 418.049 531.187 566.979 394.534C694.657 269.629 513.827 78.7963 567.198 -3.74124C652.892 -136.264 770.024 -399.526 581.069 -399.717C401.231 -399.899 206.659 -31.9488 194.643 162.667Z" fill="{{$data->colors_list[0]->id}}"/>@endif
            @if(isset($data->colors_list[2]))
                <path d="M264.838 307.705C289.947 338.245 298.128 399.204 267.261 424.582C236.393 449.96 197.396 454.838 165.421 434.014C119.198 403.911 129.707 333.357 160.575 307.979C191.442 282.601 222.921 256.721 264.838 307.705Z" fill="{{$data->colors_list[2]->id}}"/>@endif
        </svg>
        <span class="cp1" style="position: absolute;display: block;top: 280px;left: 350px;text-transform: uppercase;font-size: 32px;color: #fff;">{{$data->colors_list[0]->id}}</span>
        <span class="cp2" style="position: absolute;display: block;top: 240px;left: 680px;text-transform: uppercase;font-size: 24px;color: #fff;">{{$data->colors_list[1]->id}}</span>
        <span class="cp3" style="position: absolute;display: block;top: 360px;left: 160px;text-transform: uppercase;font-size: 20px;color: #fff;">{{$data->colors_list[2]->id}}</span>
...
<div class="page-break pb27-27"></div> 		@php
    function adjustBrightness_3($hex, $steps) {
			...
			function getContrastColor_3($bg)
			{
...
@endphp
<div id="page26-26" class="@if(count($data->colors_list)<5) colors-4 @endif" style="position: relative;padding-top: 480px;">
    @php
        $page_number++;
    @endphp
    <div class="page-number" id="Color Palette">{{$page_number}}</div>
    ...
    @else
        ...
        @endphp
    @endif
    <div class="color-blocks" style="height: 410px;width: 580px;position: absolute;left: 90px;top:90px;align-items: center;display: flex;flex-wrap: nowrap;flex-shrink: 0; flex-grow: 0;justify-content: space-between;">
        @foreach($data->colors_list as $c=>$color)
            @if($c<$cllimit && $c>=$cloffset)
                @if(isset($color->color))
                    <div class="color-block" style="margin-bottom: 20px;flex-basis: 137px; @if(count($data->colors_list)<=4 && $c==1) margin-right: 45px; @endif" {{--style="@if($c<2) margin-top:42px; @endif"--}}>
...
box-shadow: 5.20389px 5.20389px 19.5146px rgba(0, 0, 0, 0.25);padding: 9px;">
                            @if($color->show_shades)<div class="darker-color" style="background: {{adjustBrightness_3($color->color->hex->value, -30)}};border-bottom: 2px solid #fff;height: 30px;display: flex;font-size: 10px;align-items: center;align-content: center;justify-content: center;color: {{getContrastColor_3(adjustBrightness_3($color->color->hex->value, -30))}};margin-bottom: 2px;">
                                {{adjustBrightness_3($color->color->hex->value, -30)}}
                            </div>
                            @endif
                            <div class="main-color" style="background: {{$color->color->hex->value}};border-bottom: 2px solid #fff;height: 120px;display: flex;align-items: center;align-content: center;justify-content: center;font-size: 14px;color: {{getContrastColor_3($color->color->hex->value)}};margin-bottom: 2px;@if(!$color->show_shades) height: 216px; margin-bottom: 40px; @endif">
                                {{$color->color->hex->value}}
                            </div>
                            @if($color->show_shades)
                                <div class="ligher-color" style="background: {{adjustBrightness_3($color->color->hex->value, 30)}};border-bottom: 2px solid #fff;height: 30px;display: flex;font-size: 10px;align-items: center;align-content: center;justify-content: center;color: {{getContrastColor_3(adjustBrightness_3($color->color->hex->value, 30))}};margin-bottom: 2px;">
                                    {{adjustBrightness_3($color->color->hex->value, 30)}}
                                </div>
                            @endif
                            @if($color->show_shades)
                                <div class="lightest-color" style="background: {{adjustBrightness_3($color->color->hex->value, 40)}};border-bottom: 2px solid #fff;height: 30px;display: flex;font-size: 10px;align-items: center;align-content: center;justify-content: center;color: {{getContrastColor_3(adjustBrightness_3($color->color->hex->value, 40))}};margin-bottom: 40px;">
                                    {{adjustBrightness_3($color->color->hex->value, 40)}}
                                </div>
                            @endif
                        </div>
                        <div class="title" style="color: #000; font-size: 13px;margin-top: 6px;margin-bottom: 6px;">{{$color->color->name->value}}</div>
                        <div class="color-block-info" style="">
                            <div class="key-value" style="display: flex;white-space: nowrap;">
                                ...
                                <div class="value" style="color: #000; font-size: 13px;">{{$color->color->hex->value}}</div>
                            </div>
                            <div class="key-value" style="flex-basis: 100%;white-space: nowrap;display: flex;">
                                ...
                                <div class="value" style="color: #000; font-size: 13px;">{{$color->color->rgb->r}} {{$color->color->rgb->g}} {{$color->color->rgb->b}}</div>
                            </div>
                            <div class="key-value" style="flex-basis: 100%;white-space: nowrap;display: flex;">
                                <div class="key" style="color: #999999; font-size: 13px;">CMYK</div>
                                <div class="value" style="color: #000; font-size: 13px;">{{$color->color->cmyk->c}} {{$color->color->cmyk->m}} {{$color->color->cmyk->y}} {{$color->color->cmyk->k}}</div>
                            </div>
                            @if($color->pantone!=null)
                                <div class="key-value" style="flex-basis: 100%;white-space: nowrap;display: flex;">
                                    <div class="key" style="color: #999999; font-size: 13px;">Pantone</div>
                                    <div class="value" style="color: #000; font-size: 13px;">{{$color->pantone->getName()}}</div>
                                </div>
                            @endif
                        </div>
                    </div>
...
<div id="page27" class="@if(count($data->colors_list)<5) colors-4 @endif" style="position: relative;">
    ...
    <div class="color-blocks" style="height: 410px;width: 580px;position: absolute;left: 90px;top:90px;align-items: center;display: flex;flex-wrap: nowrap;flex-shrink: 0; flex-grow: 0;justify-content: space-between;">
        @foreach($data->colors_list as $c=>$color)
            @if($c<$cllimit && $c>=$cloffset)
                @if(isset($color->color))
                    <div class="color-block" style="margin-bottom: 20px;flex-basis: 137px; @if(count($data->colors_list)<=4 && $c==2) margin-left: 45px; @endif" {{--style="@if($c<2) margin-top:42px; @endif"--}}>
                        <div class="color-block-color" style="border: 1.30097px solid #C5C3C3;
box-sizing: border-box;
box-shadow: 5.20389px 5.20389px 19.5146px rgba(0, 0, 0, 0.25);padding: 9px;">
                            @if($color->show_shades)<div class="darker-color" style="background: {{adjustBrightness_3($color->color->hex->value, -30)}};border-bottom: 2px solid #fff;height: 30px;display: flex;font-size: 10px;align-items: center;align-content: center;justify-content: center;color: {{getContrastColor_3(adjustBrightness_3($color->color->hex->value, -30))}};margin-bottom: 2px;">
...
<div id="page28" style="">
    ...
    @if(isset($data->fonts_main[1]))
        <div class="huge-text text-one" style="border: none">
            <div style="overflow: hidden;height: 200px;width: 1072px;position: absolute;color: #D4D4D4;left: -104px;top: -95px;font-size: 200px;font-weight: 900;line-height: 200px;white-space: nowrap;"><div style="position: absolute;right: 0; bottom: 0;font-family: 'main1';l">{{$data->fonts_main[1]['font_face']}}</div></div>
            @if(isset($data->colors_list[0]) && isset($data->colors_list[0]->id))
                <div class="color" style="position: absolute;color: #EAEAEA;top: 90px;left: 145px;font-weight: 800;text-transform: uppercase;font-size: 50px;">
                    {{$data->colors_list[0]->id}}
                </div>
            @endif
            <small class="color-subtext" style="color: ##D4D4D4;color: #D4D4D4;position: absolute;left: 210px;top: 160px;width: 420px;     white-space: unset;display: block;">
                <svg width="155" height="99" viewBox="0 0 155 99" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M153.001 96.6665H96.3169L1.54883 1.89844" stroke="#D4D4D4" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
    ...
    @if(isset($data->fonts_main[2]))
        <div class="huge-text text-one" style="border: none">
            <div style="overflow: hidden;height: 200px;width: 750px;position: absolute;color: #EAEAEA;left: -104px;top: 255px;font-size: 120px;font-weight: bold;line-height: 200px;font-family: 'main2'"><div style="position: absolute;right: 0; font-family: 'main2';white-space: nowrap;">{{$data->fonts_main[2]['font_face']}}</div></div>
            <small class="color-subtext" style="color: #EAEAEA;color: #EAEAEA;position: absolute;left: 380px;top: 420px;width: 420px;     white-space: unset;display: block;">
                <svg width="155" height="99" viewBox="0 0 155 99" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M153.001 96.6665H96.3169L1.54883 1.89844" stroke="#EAEAEA" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
...
<div id="page29" style=" padding-top: 350px;">
    ...
    top: -50px;"><div style="position: absolute;right: 0; bottom: 0;font-family: 'main1';l">{{$data->fonts_main[1]['font_face']}}</div></div>
            <small class="color-subtext" style="color: #d4d4d4;position: absolute;left: 280px;top: 70px;width: 460px;     white-space: unset;display: block;">
                <svg width="170" height="4" viewBox="0 0 170 4" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0.572266" y="0.945312" width="168.449" height="3" fill="#d4d4d4"/></svg>
...
<div id="page30">
    ...
    @endphp
    <div class="page-number">{{$page_number}}</div>
    <div class="fonts2-title" style="padding-left: 171px;">Primary Font</div>
    {{-- <div class="gradient-line"></div> --}}
    @if(isset($data->fonts_main) && isset($data->fonts_main[1]))
        <div class="fonts2-fontname" style="font-weight: normal;font-size: 36px;padding-left: 171px;">{{$data->fonts_main[1]['font_face']}}</div>
    @endif
    @foreach($data->fonts_main as $fm)
        @if(isset($fm['index']))
            <div style="display: flex; flex-wrap: nowrap; margin-bottom: 20px; align-items: center;">
                <div style="border-right: 1px solid #000000;font-family: 'main{{$fm['index']}}';padding: 12px; margin-right: 40px;width: 131px; box-sizing: border-box;height: auto;text-align: center;">
...
<div id="page31">
    ...
    <div class="page-number right">{{$page_number}}</div>
    @if(isset($data->fonts_secondary) && isset($data->fonts_secondary[1]))
        <div class="fonts2-title"style="padding-left: 171px;">Secondary Font</div>
    @endif
    @if(isset($data->fonts_secondary) && isset($data->fonts_secondary[1]))
    ...
    @foreach($data->fonts_secondary as $fs)
        @if(isset($fs['index']))
            <div style="display: flex; flex-wrap: nowrap; margin-bottom: 20px; align-items: center;">
                <div style="border-right: 1px solid #000000;font-family: 'second{{$fs['index']}}';padding: 12px; margin-right: 40px;width: 131px; box-sizing: border-box;height: auti;text-align: center;">
...
@if(isset($data->mockups[3]))
    @if(!empty($data->mockups[3]->title))
        <div id="page-mockup-4-0">
            ...
            <div class="page-number">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-left-full-right-half" style="background-image: url({{$data->mockups[3]->image}})"></div>
            </div>
        </div>
        <div id="page-mockup-4-1">
            ...
            <div class="page-number right">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-right-half" style="background-image: url({{$data->mockups[3]->image}})"></div>
                <div class="mockup-title right">
    ...
    @else
        <div id="page-mockup-4-0">
            ...
            <div class="page-number">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-left-full" style="background-image: url({{$data->mockups[3]->image}})"></div>
            </div>
        </div>
        <div id="page-mockup-4-1">
            @php
            ...
            <div class="page-number right">{{$page_number}}</div>
            <div class="mockup-wrapper">
                <div class="mockup-photo mockup-photo-right-full" style="background-image: url({{$data->mockups[3]->image}})"></div>
            </div>
        </div>
    @endif
@endif
<div id="page32">
    ...
    <h1 class="title " style="white-space: nowrap;">Brand Book Designer</h1>
    <div class="text ">
    ...
    <div class="company">
        ...
        <div class="web">
            ...
            @if(!empty($data->user->company_dribble))
                <p  style="color: #000"><i class="fa fa-dribbble" style="margin-right: 5px; display: inline-block;"></i>{{$data->user->company_dribble}}</p>
            @endif
            @if(!empty($data->user->company_behance))
                <p style="color: #000"><i class="fa fa-behance" style="margin-right: 5px; display: inline-block;"></i>{{$data->user->company_behance}}</p>
            @endif
        </div>
        <div class="contact">
            <p style="color: #000">Contact</p>
            @if(!empty($data->user->company_phone))
                <p style="color: #000"><i class="fa fa-mobile" style="margin-right: 5px; display: inline-block;"></i>{{$data->user->company_phone}}</p>
            @endif
            @if(!empty($data->user->email))
                <p style="color: #000"><i class="fa fa-envelope" style="margin-right: 5px; display: inline-block;"></i>{{$data->user->email}}</p>
            @endif
        </div>
    </div>
</div>
...
<div id="page36">
    {{-- <div class="gradient"></div> --}}
    <div class="company-logo" style="width: 100%;height: 760px;display: flex;align-items: center;justify-content: center;">
        <img src="{{$data->logo_b64}}" alt="" style="width: 380px;height: auto;">
    </div>
    <div class="small-title" style="color: #000;">
        {{$data->brand}} Brand Book
    </div>
    <div class="logo-gingersauce" style="color: #000;"><svg width="14" height="14" viewBox="0 0 6 6" xmlns="http://www.w3.org/2000/svg"><path d="M0.7229 0.8125V5.56588H5.47628V0.8125H0.7229ZM3.46099 4.80819C2.86097 4.91039 2.22155 4.75937 1.71987 4.33837L2.14416 3.83256C2.52286 4.15037 3.01455 4.24491 3.46094 4.13326L3.46099 4.80819ZM3.46099 2.35792C3.37053 2.26076 3.242 2.19958 3.09902 2.19958C2.82599 2.19958 2.60386 2.42171 2.60386 2.69465C2.60386 2.96768 2.82594 3.18985 3.09902 3.18985C3.24195 3.18985 3.37048 3.12863 3.46099 3.03147V3.79111C3.347 3.8289 3.22551 3.85 3.09902 3.85C2.46197 3.85 1.94366 3.33174 1.94366 2.6946C1.94366 2.0576 2.46197 1.53934 3.09902 1.53934C3.22551 1.53934 3.34696 1.56044 3.46099 1.59823V2.35792Z" fill="#000" /></svg> Powered by gingersauce</div>
</div>
</div>
</body>
</html>
