                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($row->getAttribute('field')=='name'): ?>
                                                <th>First Name</th>
                                                <th>Last Name</th>
                                            <?php else: ?>
                                                <th>
                                            ...
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($dataType->slug=='users'): ?>
                                            <th>Total amount spent</th>
                                            <th>Credits (used/total)</th>
                                            <th>Credits from referals</th>
                                            <th>Shares</th>
                                            <th>Last date login</th>
                                            <th>Link to user invoice history</th>
                                        <?php endif; ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $dataTypeContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(($dataType->slug=='invoices' && isset($_GET['user_id']) && $_GET['user_id']==$data['user_id']) || !isset($_GET['user_id']) || $dataType->slug!='invoices'): ?>
                                                <tr>
                                                    <?php if($showCheckboxColumn): ?>
                                                        <td>
                                                    ...
                                                    <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        ?>
                                                        <?php if($dataType->slug=='users' && $row->field=='name'): ?>
                                                            <?php
                                                        ...
                                                        <?php else: ?>
                                                            <td>
                                                                ...
                                                                <?php elseif($row->type == 'image'): ?>
                                                                    <img src="<?php if( !filter_var($data->{$row->field}, FILTER_VALIDATE_URL)): ?><?php echo e(str_replace('/storage/storage', '/storage', Voyager::image( $data->{$row->field}) )); ?><?php else: ?><?php echo e($data->{$row->field}); ?><?php endif; ?>" style="width:100px">
                                                    ...
                                                    <?php if($dataType->slug=='users'): ?>
                                                        <?php
                                                            $user_data = App\User::get_data_for_admin($data->id);
                                                        ?>
                                                        <td>$ <?php echo e($user_data['amount_spent']); ?></td>
                                                        <td>
                                                            <a href="/restricted/brandbooks?key=user_id&filter=equals&s=<?php echo e($data->id); ?>">
                                                                <?php echo e($user_data['credits_used']); ?> / 
                                                                <?php echo e($user_data['credits_total']); ?>

                                                            </a>
                                                        </td>
                                                        <td><?php echo e($user_data['credits_ref']); ?></td>
                                                        <td><?php echo e($data->shares()->distinct('user_email')->count('user_email')); ?></td>
                                                        <td><?php if(!empty($data->last_login)): ?><?php echo e(Carbon\Carbon::parse($data->last_login)->format('d.m.Y H:i:s')); ?><?php endif; ?></td>
                                                        <td><a href="<?php echo e(route('voyager.invoices.index')); ?>?user_id=<?php echo e($data->id); ?>" target="_blank">Invoices</a></td>
                                                    <?php endif; ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/pankaj/code/gingersauce_prod/resources/views/vendor/voyager/users/browse.blade.php ENDPATH**/ ?>