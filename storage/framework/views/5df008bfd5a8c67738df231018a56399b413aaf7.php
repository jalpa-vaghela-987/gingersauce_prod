                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(isset($data->user)): ?>
                                                <a href="/restricted/users?key=email&filter=contains&s=<?php echo e($data->user->email); ?>">
                                        ...
                                        <td><?php echo e($data->publicUsers()); ?></td>
                                        <td><?php echo e($data->loggedInUsers()); ?></td>
                                        <td><?php if($data->finished()): ?><?php echo e('Complete'); ?><?php else: ?><?php echo e($data->completed); ?><?php endif; ?></td>
                                        <td><a href="<?php echo e(route('admin.brandbook-files', $data->id)); ?>" target=_blank>Download</a></td>
                                        <td>
                                            <?php $__currentLoopData = $data->shares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $share): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div>
                                                    <?php if(isset($share->user_id)): ?>
                                                        &#x263B;<?php echo e($share->user->email); ?> (<?php echo e($share->action); ?>)
                                                    <?php else: ?>
                                                        <?php echo e($share->user_email); ?> (<?php echo e($share->action); ?>)
                                                    <?php endif; ?>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </td>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/pankaj/code/gingersauce_prod/resources/views/vendor/voyager/brandbooks/browse.blade.php ENDPATH**/ ?>