                                                ...
                                                <tr>
                                                    ...
                                                    <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php elseif($row->type == 'relationship'): ?>
                                                                <?php if($row->display_name == 'users'): ?>
                                                                    <a href="<?php echo e(route('voyager.users.show',$data->user->id)); ?>" target="_blank"><?php echo e($data->user->name); ?></a>
                                                    ...
                                                    <td class="no-sort no-click" id="bread-actions">
                                                        <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <button type="button" class="btn btn-default pull-right unSubscribeBtn" data-id="<?php echo e($data->id); ?>">Unsubscribe</button>
                                                    </td>
                                                </tr>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/pankaj/code/gingersauce_prod/resources/views/vendor/voyager/invoices/browse.blade.php ENDPATH**/ ?>