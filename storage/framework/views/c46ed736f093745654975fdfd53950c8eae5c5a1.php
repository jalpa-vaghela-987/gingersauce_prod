<?php if(!((\Request::segment(2) ===  "edit-new" || \Request::segment(2) ===  "view-new" )&& (int)\Request::segment(3))): ?>
<header class="auth">
    <nav class="navbar navbar-expand-md navbar-light bg-white">
        <div class="col-3 h-100 p-0">
            <div class="brand-logo-block text-center h-100">
                <a class="navbar-brand bg-white" href="<?php echo e(url('/')); ?>">
                ...
                <a href="/my/new" class="header-add-new d-none btn btn-danger rounded-0 h-100"
                   style="position: absolute;right: 0;display: block;top: 0;bottom: 0;width: calc(100% - 50px);">
                    ...
                    <span class="d-inline"><?php echo e(trans('general.create_new')); ?></span>
                </a>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a href="<?php echo e(route('brandbook.my')); ?>" class="nav-link"><?php echo e(__('My Brandbooks')); ?></a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('profile.plans-pricing')); ?>" data-toggle="modal" data-target="#modal-buy-plan" class="nav-link bg-success text-white" style="border-radius: 30px;"><?php echo e(__('Purchase Now')); ?></a>
                </li>
                <li class="nav-item d-none">
                    <?php if(Auth::user()->credits()>0): ?>
                        <?php if('brandbook.my'==Route::currentRouteName()): ?>
                            <router-link to="/my/new" class="nav-link btn btn-danger">
                                ...
                                <span><?php echo e(__('Create')); ?></span></router-link>
                        <?php else: ?>
                            <a href="<?php echo e(route('brandbook.my')); ?>/new" class="nav-link btn btn-danger">
                                <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7 0H5V5H0V7H5V12H7V7H12V5H7V0Z"
                                          fill="white"/>
                                </svg>
                                <span><?php echo e(__('Create')); ?></span></a>
                        <?php endif; ?>
                    <?php else: ?>
                        <a href="<?php echo e(route('profile.plans-pricing')); ?>" class="nav-link btn btn-danger">
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7 0H5V5H0V7H5V12H7V7H12V5H7V0Z"
                                      fill="white"/>
                ...
                <li class="nav-item d-none">
                    <a href="" class="nav-link"><?php echo e(__('Community')); ?></a>
                </li>
            </ul>
                ...
                <?php else: ?>
                    <li class="nav-item dropdown pl-0 nav-item-user d-none d-md-block">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle-" href="#" role="button"
                           ...
                           style="line-height: 40px;">
                            <?php echo e(trans('general.get_free_credits')); ?>
                    ...
                    <li class="nav-item package-block">
                        <strong style="margin-top: 10px;display: block;"><span><span class="font-weight-bold"
                                            id="left_credits"><?php echo e(Auth::user()->credits()); ?></span> <?php echo e(trans('general.books_left')); ?></span></strong>
                    </li>
                    <li class="nav-item dropdown pl-0 nav-item-user">
                        <a id="navbarDropdown" id="username" class="nav-link dropdown-toggle" href="#" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            <img src="<?php echo e(url(Auth::user()->avatar)); ?>"
                                 class="img-thumbnail border-danger avatar rounded-circle">
                            <span class="text-truncate"><?php echo e(Auth::user()->name); ?></span> <span class="caret"></span>
                        </a>

                        <div class="dropdown-menu dropdown-menu-right main-menu-block" aria-labelledby="navbarDropdown">
                            <a href="<?php echo e(route('profile.plans-pricing')); ?>" class="dropdown-item"><i
                                    class="fas fa-tag"></i><?php echo e(__('Plans & Pricing')); ?></a>
                            <a href="<?php echo e(route('profile.my')); ?>" class="dropdown-item"><i class="fa fa-user"
                                                                                       aria-hidden="true"></i><?php echo e(__('My Profile')); ?>

                            </a>
                            <a href="<?php echo e(route('profile.plans')); ?>" class="dropdown-item"><i class="fa fa-list-alt"
                                                                                          aria-hidden="true"></i><?php echo e(__('profile.my_plans')); ?>

                            </a>
                            <a href="<?php echo e(route('billing.index')); ?>" class="dropdown-item"><i class="fa fa-credit-card"
                                                                                          aria-hidden="true"></i><?php echo e(__('profile.billing')); ?>

                            </a>
                            <a href="<?php echo e(route('invoice.index')); ?>" class="dropdown-item"><i class="fa fa-history"
                                                                                          aria-hidden="true"></i><?php echo e(__('profile.purchase_history')); ?>

                            </a>
                            <a href="#" class="dropdown-item submenu"><i
                                    class="fas fa-globe-americas"></i><?php echo e(trans('general.language')); ?></a>
                            <div class="dropdown-menu">
                                <?php $__currentLoopData = config('app.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="dropdown-item"
                                       href="<?php echo e(route('setLocale', ['lang' => $locale ])); ?>"><?php echo e($locale); ?></a>
...
<?php endif; ?>
<?php /**PATH /Users/pankaj/code/gingersauce_prod/resources/views/parts/headers/auth.blade.php ENDPATH**/ ?>